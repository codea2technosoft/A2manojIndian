...
import { Spin, Table, Switch, Row, InputNumber, Button, Card,} from "antd";
      ...
      render: (text, record) => {
        return (
          <InputNumber
            ...
            defaultValue={text}
            onChange={(value) =>
              onUpdate(record.id, { transaction_fee_rate_payout: value })
            }
          />
        );
      },
      ...
      render: (text, record) => {
        return (
          <InputNumber
            ...
            defaultValue={text}
            onChange={(value) =>
              onUpdate(record.id, { revered_fee_rate_payout: value })
            }
          />
        );
      },
