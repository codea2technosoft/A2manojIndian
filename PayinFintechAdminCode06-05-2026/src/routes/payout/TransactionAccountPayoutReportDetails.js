...
// request
import { payoutgetPartnerSummarySecond } from "requests/statistic";
import { getOrders, exportOrdersPayoutSecond } from "requests/order";
...
function TransactionAccountPayoutReportDetails() {
  ...
  //     console.warn("ddddddddddddd",response);

  //     const text = await response.data();
  //     console.log("manoj data",text);
  //     const jsonData = JSON.parse(text);
...
export default TransactionAccountPayoutReportDetails;
