...
// request
import { getManagerParnter, updatePartner, updatePartnerPayinPayout } from 'requests/user';

const MerchantPartnerList = () => {
    ...
    const titles = [{ path: location.pathname, title: 'partner Detail' }];
    <button></button>
    ...
    const getRecords = async (query) => {
        try {
            ...
            const response = await getManagerParnter(query);
...
export default MerchantPartnerList;
