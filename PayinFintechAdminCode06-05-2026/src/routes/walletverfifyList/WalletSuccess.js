...
function WalletSuccess() {
  ...
  const getRecords = async (query) => {
    try {
      ...
      const response = await getWalletSuccessreport(query, idname);
  ...
  return (
    <div className="wrap-orders transaction">
      ...
      <Row gutter={[8, 8]} className="mt-2">
        ...
        <Col xs={12} sm={12} md={12} lg={12} xl={6}>
          <div className="payintopayoutnew box2">
        ...
        {/* <Col xs={12} sm={12} md={12} lg={12} xl={6}>
          <div className="payintopayoutnew box3">
            <div className="payintopayoutnew-header">Payin Manual Settlement Amount</div>
            <div className="payintopayoutnew-body">
              <FaRupeeSign />
              {PayinSettlmentAmt}
            </div>
