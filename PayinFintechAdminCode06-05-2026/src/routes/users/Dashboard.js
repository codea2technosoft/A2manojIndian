...
// request
import { getManager, partnerpayoutpayinpermission, partnerpayoutpayoutpermission, updatePartnerPayinPayout } from 'requests/user';
...
const Dashboard = () => {
    ...
    const titles = [{ path: location.pathname, title: 'Dashboard Setting' }];
    ...
    const columns = [
        ...
        },
        {
            title: 'Actions',
            render: (record) => (
                <Link to={`/dashboard-users-detail`}>
