		...
		>
			...
			<Form layout="vertical" form={formRef} initialValues={record} key={formKey}>
				<Row gutter={[16, 16]}>
					...
					<Col g={12} md={12} sm={24} xs={24}>
						<Form.Item name="simple_pass" label="Password" rules={[{ required: true }]}>
							<Input />
						</Form.Item>
					</Col>

					<Col g={12} md={12} sm={24} xs={24}>
						<Form.Item name="PAN_GST" label="Pan/GST" rules={[{ required: true }]}>
							<Input />
						</Form.Item>
					</Col>
...
<Row gutter={[16, 16]}>
					<Col g={12} md={12} sm={24} xs={24}>
					<Form.Item name="paypal_client_id" label="Paypal Client Id" rules={[{ required: false }]}>
							<Input />
						</Form.Item>
					</Col>
					<Col g={12} md={12} sm={24} xs={24}>
						<Form.Item name="paypal_secret_id" label="Paypal Secret Id" rules={[{ required: false }]}>
							<Input />
						</Form.Item>
					</Col>
				</Row>
