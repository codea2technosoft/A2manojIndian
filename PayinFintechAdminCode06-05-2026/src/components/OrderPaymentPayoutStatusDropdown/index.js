...
// request
import { updateOrderPayoutDetail } from 'requests/order';

const OrderPaymentPayoutStatusDropdown = (props) => {
    ...
    const onChange = (selectedValue) => {
        ...
        if (onChangeStatus) {
            ...
            updateOrderPayoutDetail(orderId, { status: selectedValue });
        }
    }
...
export default OrderPaymentPayoutStatusDropdown;