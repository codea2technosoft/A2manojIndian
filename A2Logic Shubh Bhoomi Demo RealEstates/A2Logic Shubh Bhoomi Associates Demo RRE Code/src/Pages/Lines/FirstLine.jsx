...
import { FaEye, FaEdit, FaUsers, FaUserCheck, FaShoppingCart, FaChartArea, FaUser, FaHistory } from "react-icons/fa";
...
function FirstLine() {
  ...
  const [searchTerm, setSearchTerm] = useState({ name: "", mobile: "" });
  ...
  const fetchData = async (page = 1) => {
    ...
    try {
      ...
      const lineResponse = await fetch(
        `${API_URL}/line-one-details-associate?page=${page}&limit=${LIMIT}`,
        {
  ...
  const handleExportAllToExcel = async () => {
    ...
    try {
      ...
      const date = new Date();
      const fileName = `Property_Records_${date.getFullYear()}-${(date.getMonth() + 1).toString().padStart(2, '0')}-${date.getDate().toString().padStart(2, '0')}.csv`;
      ...
      <div className="card">
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between gap-2">
            <div className="titlepage">
              <h3>{lineData.line_info?.line_name || "First Line"} - Property Records</h3>
            </div>
        ...
        <div className="card-body">
          ...
          {loading || loadingRecords ? (
            ...
            <>
              {/* Property Records Table with Running Total */}
              <div className="card">
                ...
                <div className="card-body p-0">
                  <div className="table-responsive" style={{ maxHeight: '600px', overflowY: 'auto', overflowX: 'auto' }}>
                    <Table bordered hover size="sm" className="mb-0" style={{ minWidth: '3000px' }}>
