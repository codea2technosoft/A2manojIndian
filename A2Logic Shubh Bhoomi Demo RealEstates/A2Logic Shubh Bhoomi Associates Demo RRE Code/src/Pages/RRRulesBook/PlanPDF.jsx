  ...
  useEffect(() => {
    ...
    const loadPdf = async () => {
      try {
        ...
        if (err.message.includes("Missing PDF") || err.message.includes("404")) {
    ...
    return (
      <div className="d-flex justify-content-center align-items-center" style={{ height: "400px" }}>
        <div className="alert alert-danger">
          ...
          {pdfUrl && (
            <div className="mt-2">
              <a href={pdfUrl} target="_blank" rel="noopener noreferrer" className="alert-link">
    ...
    try {
      ...
      if (responseData.upload_rre_plans_pdf) {
        setPreviousList([
          {
            id: 1,
            title: "Demoo Real Estates Rules Book Details",
