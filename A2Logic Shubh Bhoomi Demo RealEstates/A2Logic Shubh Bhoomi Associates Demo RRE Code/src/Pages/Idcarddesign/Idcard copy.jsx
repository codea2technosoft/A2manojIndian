...
const Idcard = () => {
  ...
  const [employee] = useState({
    name: "John Doe",
    id: "RE12345",
    designation: "Demo Real Estates",
    company: "Demo Real Estates",
              ...
              {profile && (
                <>
                  ...
                  <div className="idcard-logo-container">
                    ...
                    <p className="idcard-logo-text">Demo Real Estates</p>
                  </div>
                </>
              )}
            </div>
                ...
                <div className="idcard-details-container">
                  ...
                  <div className="idcard-detail-row">
                    ...
                    <div className="idcard-detail-text">
                      ...
                      <div className="design_name">{profile.company_name ? `${profile.company_name}` : 'Demo Real Estates'}</div>
                    </div>
                  </div>
