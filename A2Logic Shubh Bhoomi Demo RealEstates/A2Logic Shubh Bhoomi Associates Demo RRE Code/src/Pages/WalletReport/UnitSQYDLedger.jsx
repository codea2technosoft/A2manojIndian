  ...
  const fetchData = async (e) => {
    ...
    try {
      ...
      if (response.data.status === "1") {
        ...
        console.log(
          "Sorted Data:",
          sortedData.map((item) => item.new_sqyd),
        );
      ...
      Swal.fire(
        "Warning !!!",
        "Sorry No Data Found Please Try Another.",
        "info",
      );
    } finally {
      setLoading(false);
                ...
                <>
                  {searchDetails && (
                    <div className="alert alert-info mb-3">
                      <strong>Search Details:</strong> {searchDetails.username}{" "}
                          ...
                          return (
                            <tr key={index}>
                              ...
                              <td className="text-end">
                                {parseFloat(row.unitSqyd).toFixed(2)}
                              </td>

                              <td className="text-center">{row.levelNo}</td>
                              <td className="text-end">
                                {parseFloat(row.oldSqyd).toFixed(2)}
                              </td>
                              <td className="text-end">
                                {parseFloat(row.unitSqyd).toFixed(2)}
                              </td>
                              <td className="text-end">
                                {parseFloat(row.new_sqyd).toFixed(2)}
                              </td>
                            </tr>
                          );
                        })}
