...
function CreateLoan() {
  ...
  const handleChange = (e) => {
    ...
    if (name === "pan_number") {
      if (!/^[A-Z0-9]{0,10}$/.test(value)) return;
    }
    setFormData((prev) => ({
      ...prev,
  ...
  const validateForm = () => {
    ...
    if (
      ...
      newErrors.pan_card_number = "Invalid PAN card format ABCDE1234F.";
      isValid = false;
    }
    ...
    if (
      formData.cibil_score === "Yes" &&
      (!formData.cibil_score_value || isNaN(formData.cibil_score_value))
    ) {
      newErrors.cibil_score_value =
        "Cibil Score Value is required when CIBIL score is 'Yes'.";
      isValid = false;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.state_name && formData.state) {
        const stateName =
          statesList.find((s) => s.id.toString() === formData.state.toString())
            ?.name || "";
        formPayload.append("state_name", stateName);
      }
      if (!formData.city_name && formData.city) {
        const cityName =
          citiesList.find((c) => c.id.toString() === formData.city.toString())
            ?.name || "";
      ...
      Swal.fire({
        icon: "success",
        title: "Success",
        text: result.message || "Loan lead created successfully!",
      ...
      if (socket && socket.readyState === WebSocket.OPEN) {
        const notificationPayload = {
          ...
          remark: `${formData.category}, ${formData.service}`,
          statusremark: "",
          order_id: "",
              ...
              <Form onSubmit={handleSubmit}>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          handleChange({
                            target: {
                              name: "pan_card_number",
                              value: e.target.value.toUpperCase(), // 👈 always convert to uppercase
                            },
                          })
                        }
                ...
                <Row>
                  ...
                  <Col md={4}>
                    <Form.Group
                      className="mb-3"
                      controlId="formRequireLoanAmount"
                    >
                      <Form.Label>
                        ...
                        onChange={(e) => {
                          ...
                          setFormData((prev) => ({
                            ...
                            state_name:
                              statesList.find(
                                (s) =>
                                  s.id.toString() === e.target.value.toString()
                              )?.name || "",
                            city: "",
                            city_name: "",
                          }));
                ...
                <Row>
                  ...
                  <Col md={4}>
                    <Form.Group
                      className="mb-3"
                      controlId="formCurrentResidenceProof"
                    >
                      <Form.Label>
                      ...
                      />
                      <Form.Control.Feedback type="invalid">
                        {errors.current_residence_proof}
                      </Form.Control.Feedback>
                    </Form.Group>
                  </Col>
                  <Col md={4}>
                    <Form.Group
                      className="mb-3"
                      controlId="formPermanentAddressProof"
                    >
                      <Form.Label>
                      ...
                      />
                      <Form.Control.Feedback type="invalid">
                        {errors.permanent_address_proof}
                      </Form.Control.Feedback>
                    </Form.Group>
                  </Col>
                  <Col md={4}>
                    <Form.Group className="mb-3" controlId="formEmployeeProof">
                      <Form.Label>
                        Employee Proof / Business Registration
                      </Form.Label>
                      <Form.Control
                        type="file"
                      ...
                      />
                      <Form.Control.Feedback type="invalid">
                        {errors.employeeProof_bussinessRegistration}
                      </Form.Control.Feedback>
                    </Form.Group>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Form.Group
                      className="mb-3"
                      controlId="formBankStatementCurrentAccount"
                    >
                      ...
                      />
                      <Form.Control.Feedback type="invalid">
                        {errors.bank_statement_current_account}
                      </Form.Control.Feedback>
                    </Form.Group>
                  </Col>
                  <Col md={4}>
