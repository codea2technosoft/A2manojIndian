...
import { FaUsers, FaLock, FaRegUserCircle, FaUserCircle } from "react-icons/fa";
import { GrChannel } from "react-icons/gr";
import logo from "../assets/images/logo.png";

import pdf from "../assets/images/rajasthanirealestate.pdf";
          ...
          <div className="row align-items-center">
            <div className="col-xl-8 col-lg-8 col-md-8 d-sm-none d-md-block d-none">
              <div className="topslogan">
                {/* <h4>Welcome To The Shubh Bhoomi Real Estate</h4> */}
