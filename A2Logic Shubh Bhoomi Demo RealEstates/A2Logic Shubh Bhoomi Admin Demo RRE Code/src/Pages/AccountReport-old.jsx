  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const transformedData = [
        ...
        {
          title: "Lifetime Royalty Balance",
          value: formatCurrency(apiData.lifetime_reward_total || 0),
          numericValue: apiData.lifetime_reward_total || 0,
          icon: "TfiGift",
          color: "success",
      ...
      <div className="card-body d-flex align-items-center gap-3">
        ...
        <div>
          ...
          {/* <small className="text-muted">
            Credit − Debit − Wallet − TDS − Monthly Royalty − Lifetime Royalty − Royalty Balance
          </small> */}

           <small className="text-muted">
                    Credit − Debit − Wallet − TDS - Monthly Royalty Balance - Lifetime Royalty Balance - Royalty Balance
                  </small>
