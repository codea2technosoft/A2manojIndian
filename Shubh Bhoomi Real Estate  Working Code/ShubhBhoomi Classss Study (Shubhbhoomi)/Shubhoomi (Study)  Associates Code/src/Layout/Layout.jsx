...
const Layout = ({ children, userType, KycStatus,mobile }) => {

  const childrenWithProps = React.Children.map(children, child =>
    React.cloneElement(child, { userType, mobile, KycStatus })
  );
    ...
    <div className="layout-wrapper active">
      <div className="app-layout">
        ...
        <div className="main-content">
          <Sidebar userType={userType} isOpen={isSidebarOpen} onToggleSidebar={toggleSidebar} />
