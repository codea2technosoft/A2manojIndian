...
const LoanRemarksLisst = () => {
  ...
  const handleResponseSubmit = async (e) => {
    ...
    try {
      ...
      setResponseError("");
      fetchRemarks();
      // showCustomMessageModal("Success", "Remark added successfully!", "success");
      Swal.fire({
        title: "Success",
                ...
                <tbody>
                  {remarkList.map((remark, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        ...
                        {remark.image ? (
                          <div className="remark-images">
                            {remark.image.split(",").map((img, index) => (
                              <div key={index} className="remark-image-wrapper">
                                {img.toLowerCase().endsWith(".pdf") ? (
                                  ...
                                  <div className="image_all_design_new">
                                    <img
                                      src={`${imageAPIURL}/uploads/loanlead/${img.trim()}`}
                                      alt={`Uploaded ${index + 1}`}
                                ...
                                <a
                                  href={`${imageAPIURL}/uploads/loanlead/${img.trim()}`}
                                  download
                      ...
                      <td><div className="table-cell-remark">{toSentenceCase(remark.response)}</div></td>
                    </tr>
                  ))}
                </tbody>
              </table>
...
export default LoanRemarksLisst;
