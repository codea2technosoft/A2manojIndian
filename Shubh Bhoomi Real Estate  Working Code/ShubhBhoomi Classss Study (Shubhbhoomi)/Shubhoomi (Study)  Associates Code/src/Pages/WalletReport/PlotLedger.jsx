...
function PlotLedger() {
  ...
  const handleProjectChange = (e) => {
    ...
    setFormData(prev => ({
      ...
      plot_id: "" // Reset plot when project changes
    }));
    setLedgerData(null); // Clear existing ledger data
  };
                  ...
                  <div className="form-group">
                    ...
                    <div className="d-flex align-items-center">
                      <div className="position-relative w-100">
                        ...
                        />
                        <FaCalendar className="position-absolute top-50 end-0 translate-middle-y me-2 text-secondary" />
                      </div>
                ...
                {/* <div className="mt-3">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <small className="text-muted">
                                            Showing {ledgerData.ledger.length} transactions
                                        </small>
                                        <div className="d-flex gap-3">
                                            <small className="text-muted">
                                                Expenses: <span className="badge bg-primary">{ledgerData.statistics.expense_entries}</span>
                                            </small>
                                            <small className="text-muted">
                                                Plot Payments: <span className="badge bg-success">{ledgerData.statistics.direct_income_entries}</span>
                                            </small>
                                            <small className="text-muted">
                                                Commissions: <span className="badge bg-warning">{ledgerData.statistics.commission_entries}</span>
                                            </small>
                                        </div>
                                    </div>
                                </div> */}
