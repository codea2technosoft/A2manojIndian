...
const Booking_forms = `${process.env.REACT_APP_IMAGE_API_URL}/uploads/websiteDocumentUpload/`;
...
const Partnermarkettingrules = () => {
    ...
    const fetchPreviousPapers = async () => {
        try {
            ...
            setdownloadpdf(responseData.Booking_forms);
            console.warn(responseData.Booking_forms);
            if (responseData.Booking_forms) {
                setPreviousList([
                    {
                        id: 1,
                        title: "Shubh Bhoomi Real Estate Partner Rules Book Details",
                        pdf: responseData.Booking_forms,
           ...
           <div className="d-none d-md-block">
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            <h3 class="main_headin-2 "> Download Booking Form</h3>
    <p class="text-muted">Here you can find all the latest plan documents and guidelines.</p>
                    ...
                    <div className="card">
                        <div className="card-header d-flex justify-content-between align-items-center">
                            <div className="card-title"><strong>Booking Form</strong></div>
                            <div >
                                <a
