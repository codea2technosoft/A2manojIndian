...
const SubadminPermission = () => {
  ...
  const initialPermissionStructure = [
...

    {
      ...
      children: [{ id: "account-report", name: "Accounts Report" }],
    },

    {
      id: "WalletLedger",
      name: "Wallet Ledger",
      children: [{ id: "admin-wallet-report", name: "Wallet Ledger" }],
    },
    ...
    },
    {
      ...
      children: [
        ...
        { id: "create-associate", name: "Create Associate" },
        { id: "today-associate-list", name: "All Today Associate List" },
        ...
        {
          id: "download-my-11level-team-data-in-excel",
          name: "Download My 11level Team",
        },
      ],
    },
    {
      ...
      children: [
        ...
        { id: "today-channel-list", name: "Today All Channel List" },
...

    {
      ...
      children: [
        ...
        {
          id: "assign-property-lead-to-subadmin",
          name: "Assign Calling Leads",
        },
        ...
        {
          id: "property-income-unit-is-not-sold-list",
          name: "Unit Is Not Sold",
        },
...

    {
      ...
      children: [
        ...
        {
          id: "monthly-or-special-self-offers-lists",
          name: "Self Offers Winners",
        },
        {
          id: "monthly-or-special-customers-offers-lists",
          name: "Customers offers Winners",
        },
        {
          id: "monthly-or-special-team-offers-lists",
          name: "Teams Offers Winners",
        },
      ],
    },

    {
      ...
      children: [
        ...
        {
          id: "senior-voice-president-rewards-lists",
          name: "Sr.Voice President Royalty",
        },
        { id: "president-fund-rewards-lists", name: "President Fund Royalty" },

        {
          id: "president-level-fund-rewards-lists",
          name: "President Level Fund Royalty",
        },
      ],
    },

    {
      ...
      children: [
        ...
        {
          id: "life-time-rewards-winner-lists",
          name: "Lifetime Rewards Winner Lists",
        },
      ],
    },
  ...
  const fetchSubadminPermissions = async () => {
    ...
    try {
      ...
      const organizedPermissions = initialPermissionStructure.map((parent) => {
        const fetchedParent = fetchedPermissions.find(
          (fp) => fp.id === parent.id,
        );

        const childrenWithStatus = parent.children.map((child) => {
          const fetchedChild =
            fetchedParent && fetchedParent.children
      ...
      if (fetchedPermissions.length === 0) {
        setPermissions(
          initialPermissionStructure.map((p) => ({
            ...p,
    ...
    try {
      ...
      const formattedPermissions = permissions.map((parent) => {
        ...
        if (!parent.id || !parent.name) {
          throw new Error(
            `Missing required permission fields for ${JSON.stringify(parent)}`,
          );
        }
        ...
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between flex-wrap-mobile gap-2">
            ...
            <div className="d-flex gap-2">
              <Link className="btn btn-primary d-flex gap-1" to="/allsubadmin">
               <IoArrowBack /> Back
              </Link>
            </div>
          </div>
              ...
              {permissions.map((parent, index) => (
                <Col md={6} lg={4} key={parent.id} className="mb-4">
                  <Card className="card_all_design">
                    <Card.Header
                      className="card_bg text-white d-flex justify-content-between align-items-center"
                      onClick={
                        ...
                        {parent.children.map((child) => (
                          <li key={child.id} className="mb-2">
                            <Form.Check
                              ...
                              checked={child.checked}
                              onChange={() =>
                                handleChildCheckboxChange(parent.id, child.id)
                              }
                            />
                          </li>
                        ))}
