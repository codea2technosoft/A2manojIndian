...
import callingleads from "../../assets/images/associates_creation_format.csv";
import { FaFileDownload } from "react-icons/fa";
const API_URL = process.env.REACT_APP_API_URL;

function CreateAssociateByUploadingCSV() {
      ...
      if (result.status === "1") {
        ...
        if (result.summary && result.summary.imported === 0) {
          Swal.fire({
            ...
            text: "Sorry, no data was imported. Please check your CSV file or duplicate try again.",
            ...
            <div className="card-header">
              <div className="d-flex flex-wrap-mobile gap-2 align-items-center justify-content-between">
                <div className="titlepage">
                  <h3>Create New Associate By Uploading CSV</h3>
                </div>

                <div className="d-flex justify-content-between">
                  <OverlayTrigger
                    placement="top"
                    overlay={<Tooltip>Download Create New Associate By Uploading CSV Format</Tooltip>}
                  >
                    <a href={callingleads}
                      className="btn btn-primary"
                      download="Associates Creation Format.csv"
                    >
                      Download CSV Format
                    </a>
                  </OverlayTrigger>
...
export default CreateAssociateByUploadingCSV;