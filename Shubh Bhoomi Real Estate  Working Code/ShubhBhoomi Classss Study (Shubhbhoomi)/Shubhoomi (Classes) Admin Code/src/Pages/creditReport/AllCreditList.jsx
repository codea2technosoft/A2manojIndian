...
function AllCredit() {
  ...
  const [searchType, setSearchType] = useState(""); // cash or online
  ...
  const fetchTransactions = async (page = 1, type = "", date = "") => {
    ...
    try {
      ...
      let url = `${API_URL}/total-credit-details?page=${page}&limit=10`;
      ...
      if (!response.ok) {
        ...
        showCustomMessageModal("Error", errorData.message || "Failed to fetch transactions.", "error");
  ...
  // Get badge for type (cash/online)
        ...
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between">
            <div className="titlepage">
              <h3>Total Credit List Details </h3>
            </div>
