...
function OnlineDebit() {
  // State for online debit transactions
  ...
  // Fetch online debit transactions
  const fetchTransactions = async (page = 1, date = "") => {
    setLoading(true);
    setError(null);
    try {
      ...
      let url = `${API_URL}/debit-online-details?page=${page}&limit=10`;
  ...
  const handleSearchClick = () => {
    setCurrentPage(1);
    fetchTransactions(1, searchDate.trim());
  };
        ...
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between">
            <div className="titlepage">
              <h3>Online Debit List Details </h3>
                ...
                {transactions.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="10" className="text-center">
                      No online debit transactions found.
                    </td>
                  </tr>
                )}
              </tbody>
