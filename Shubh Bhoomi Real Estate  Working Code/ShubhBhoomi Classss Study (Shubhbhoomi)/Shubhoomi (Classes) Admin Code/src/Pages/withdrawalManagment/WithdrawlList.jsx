    ...
    <>
      <div className="card mt-2">
        <div className="card-header">
          <div className="d-flex flex-wrap-mobile gap-2 justify-content-between align-items-center">
          ...
          >
              ...
              <Form>
                ...
                {selectedPaymentMode === "online" && (
                  <>
                    <Form.Group className="mb-3">
                      <Form.Label>
                        Payment UTR <span className="text-danger">*</span>
                      </Form.Label>
                      <Form.Control
                        type="text"
            ...
            <Modal.Footer>
              ...
              <Button
                ...
                disabled={
                  loading ||
                  (selectedPaymentMode === "online" && !paymentUrl.trim()) ||
                  !selectedPaymentMode
                }
              >
                {loading ? (
