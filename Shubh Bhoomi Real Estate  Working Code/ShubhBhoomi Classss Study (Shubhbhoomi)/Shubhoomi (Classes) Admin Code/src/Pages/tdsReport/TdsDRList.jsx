...
function TdsDRList() {
  ...
  const fetchTdsDRList = async (page = 1, withdrawId = "", userId = "") => {
    ...
    try {
      ...
      let url = `${API_URL}/tds-dr-list?page=${page}&limit=10`;
            ...
            <div className="col-md-3">
              <div className="card bg-light">
                <div className="card-body">
                  ...
                  <h4 className="card-text text-primary">₹ {formatCurrency(summary.total_amount)}</h4>
                </div>
              </div>
            </div>
            <div className="col-md-3">
              <div className="card bg-light">
                <div className="card-body">
                  <h6 className="card-title text-muted">Total TDS</h6>
                  <h4 className="card-text text-danger">₹ {formatCurrency(summary.total_tds)}</h4>
                </div>
              </div>
            </div>
            <div className="col-md-3">
              <div className="card bg-light">
                <div className="card-body">
                  <h6 className="card-title text-muted">Total Net Payment</h6>
                  <h4 className="card-text text-success">₹ {formatCurrency(summary.total_net_payment)}</h4>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          ...
                          <button
                            ...
                            onClick={() => handleOpenSettleModal(withdrawal)}
                          >
                            Settle
                          </button>
                        </div>
