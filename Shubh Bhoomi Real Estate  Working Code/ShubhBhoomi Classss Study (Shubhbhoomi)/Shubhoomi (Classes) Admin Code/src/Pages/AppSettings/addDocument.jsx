  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/realstate-website-document-upload`,
        {
          method: "POST",
          headers: headers,
          body: formData,
    ...
    <div className="">
      ...
      {showMessageModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div
            className="bg-white rounded-lg shadow-xl w-11/12 md:w-1/3 p-6 border-t-4"
            style={{
              borderColor:
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h5
                className={`text-lg font-bold ${messageModalContent.type === "success" ? "text-green-600" : messageModalContent.type === "error" ? "text-red-600" : "text-yellow-600"}`}
              >
