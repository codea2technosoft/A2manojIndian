...
function BlockedInactiveAssociatesCommissions() {
  const { id } = useParams();
  ...
  const fetchParentCommission = async (page = 1) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/blocked-inactive-associates-commissions?${params}`,
        {
          method: "GET",
          headers: {
  ...
  return (
    <div className="card mt-2">
      <div className="card-header gap-2 d-flex  justify-content-between align-items-md-center">
        <div className="titlepage">
          <h3 className="mb-0" style={{whiteSpace:"normal"}}>
            Blocked Or Inactive Associates Commissions Details{" "}
          </h3>
        </div>
...
export default BlockedInactiveAssociatesCommissions;
