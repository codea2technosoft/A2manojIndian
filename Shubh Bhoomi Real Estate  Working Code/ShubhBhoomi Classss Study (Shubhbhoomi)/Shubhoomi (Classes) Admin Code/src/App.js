    ...
    try {
      if (roles === "admin") {
        ...
        if (res.ok) {
          ...
          // 🔴 CHANGE 1: HomeDashboard hamesha allowed
          allowedRoutes.push("/homedashboard");
...
<Route path="/property-awards-team-winners-histories" element={<PrivateRoute allowedRoutes={permissions}><Layout userType={userTypeState} permissions={permissions}> <ProprtyAwardsTeamWinnerHistories /> </Layout></PrivateRoute>} />  */}
        ...
        <Route path="/tds-dr-report" element={<PrivateRoute allowedRoutes={permissions}><Layout userType=
        {userTypeState} permissions={permissions}> <TdsDRList /> </Layout></PrivateRoute>} />

        {/* <Route path="/cr-settle-reports" element={<PrivateRoute allowedRoutes={permissions}><Layout userType={userTypeState} permissions={permissions}> <TdsSettleCRList /> 
        </Layout></PrivateRoute>} />
