  ...
  return (
    <div className="footer_all_design">
      <footer className="pt-75">
            ...
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
              <div className="footer_first">
                ...
                <p>
                  ...
                  houses, resorts, other properties, etc..
                </p>
              </div>
            </div>
              ...
              <div className="footer_contact">
                ...
                {contactInfo.map((item, index) => (
                  <div key={index} className="footer_contact_wrapper">
                    <div className="icon_location">{item.icon}</div>
          ...
          <div className="mil-footer-links">
            <ul className="mil-social mil-light">
              <li className="mil-adapt-links">
                <a href="index.html">
                  {" "}
                  © 2025 Shubh Bhoomi Real Estate Pvt Ltd. All rights reserved.
                </a>
              </li>
            </ul>
        ...
        {/* <div className="whatsappicon fixeditems">
          <Link to="https://wa.link/ars8r4" target="_blank" rel="noreferrer">
            <img alt="whatsapp" src={whatsapp} />
          </Link>
        </div> */}
        ...
        <div className="whatsappicon fixeditems">
          <Link
            to={
              siteSettings?.whatsapp_link?.trim() !== ""
                ? siteSettings.whatsapp_link
                : "https://wa.me/"
            }
            target="_blank"
