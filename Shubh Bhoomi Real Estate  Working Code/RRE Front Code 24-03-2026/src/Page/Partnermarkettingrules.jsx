...
const marketting_partner_rules_regulations = `${process.env.REACT_APP_IMAGE_API_URL}/uploads/websiteDocumentUpload/`;
...
const Partnermarkettingrules = () => {
    ...
    const fetchPreviousPapers = async () => {
        try {
            ...
            setdownloadpdf(responseData.marketting_partner_rules_regulations);
            console.warn(responseData.marketting_partner_rules_regulations);
            if (responseData.marketting_partner_rules_regulations) {
                setPreviousList([
                    {
                        id: 1,
                        title: "Shubh Bhoomi Real Estate Partner Rules Book Details",
                        pdf: responseData.marketting_partner_rules_regulations,
           ...
           <div className="d-none d-md-block">
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            <h3 class="main_headin-2 "> Download Partner Marketing Rules Book Details</h3>
                    ...
                    <div className="card">
                        <div className="card-header d-flex justify-content-between align-items-center">
                            <div className="card-title"><strong>Partner Marketing Rules Book Details</strong></div>
                            <div >
                                <a
...
export default Partnermarkettingrules;