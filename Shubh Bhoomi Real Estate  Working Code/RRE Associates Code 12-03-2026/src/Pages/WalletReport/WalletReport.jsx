  ...
  const handleDownloadFilteredExcel = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/download-wallet-ledger-excel?${params.toString()}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
        ...
        <div className="card shadow-sm">
          ...
          {isFilterActive && (
            <div className="card-body">
              <div className="d-flex flex-wrap-mobile align-items-md-center gap-2 mobilesed">
                <div className="w-100">
                  <input
                    type="date"
            ...
            <>
              <div className="card-body pb-0">
                <Row>
                  ...
                  <Col md={4} className="mb-2">
                    <div
                      className="card border-danger bg_card_design clickable-card"
                      style={{ height: "90px" }}
                    >
                      <div className="card-body p-2 text-center">
                  ...
                  <Col md={4} className="mb-2">
                    <div
                      className="card border-warning bg_card_design clickable-card"
                      style={{ height: "90px" }}
                    >
                      <div className="card-body p-2 text-center">
              ...
              {totalPages > 1 && (
                <>
                  <div className="d-flex justify-content-end mt-3">
                    {" "}
                    {/* Changed from justify-content-center to justify-content-end */}
                    <Pagination>
                      <Pagination.First
                  ...
                  <div className="text-end mt-2">
                    {" "}
                    {/* Changed from text-center to text-end */}
                    <small className="text-muted">
                      Page {currentPage} of {totalPages}
                      {totalPages > 0 &&
                        ` | Showing ${ledger.length} records (Serial: ${(currentPage - 1) * pageLimit + 1} to ${(currentPage - 1) * pageLimit + ledger.length})`}
                    </small>
                  </div>
                </>
              )}
