    ...
    try {
      ...
      if (data.status === "1" && data.plots && Array.isArray(data.plots)) {
        ...
        data.plots.forEach((plot) => {
          totalItems +=
            (plot.commissions?.length || 0) + (plot.plot_entries?.length || 0);
        });
      ...
      if (plotItem.commissions && Array.isArray(plotItem.commissions)) {
        plotItem.commissions.forEach((commission) => {
          ...
          flatData.push({
            ...
            unitNo: plot.plot_shop_villa_no || "-",
            name:
              commission.customer_name || `Level ${commission.level} Associate`,
      ...
      <div className="userlist">
        <div className="card bg-white">
          <div className="card-header">
            <div className="d-flex align-items-md-center flex-wrap-mobile justify-content-between">
              <div className="titlepage">
                <h3 style={{ whiteSpace: "normal" }}>
                  Unit SQYD Added To All Associates In One Unit Lists
                </h3>
              </div>
          ...
          <div className="card-body">
            {isFilterActive && (
              <div className="d-flex gap-2 mb-3 align-items-md-end mt-2 flex-wrap-mobile">
                <div className="w-100">
                ...
                <div className="w-100" id="searchAssociate">
                  <div className="form-group">
            ...
            <div className="gap-2 mb-3 align-items-md-end mt-2 flex-wrap-mobile d-none d-md-flex">
              <div className="w-100">
                <div className="form-group">
                  <label>
                    Project <span className="text-danger">*</span>
            ...
            {loading ? (
                    ...
                    <Card.Body>
                      <Row>
                        ...
                        <Col md={3}>
                          ...
                          <p className="mb-0">
                            {ledgerData.user.mobile || "-"}
                          </p>
                        </Col>
                        <Col md={3}>
                          <strong>Total Area (SQYD):</strong>
                          <p className="mb-0">
                            {parseFloat(ledgerData.user.buysqrt || 0).toFixed(
                              2,
                            )}
                          </p>
                        </Col>
              ...
              <div className="text-center">
                <BsEye size={32} className="text-muted" />
