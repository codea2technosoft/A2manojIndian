...
const Idcard = () => {
  ...
  const [employee] = useState({
    name: "John Doe",
    id: "RE12345",
    designation: "Shubh Bhoomi Real Estates",
    company: "Shubh Bhoomi Real Estates",
                ...
                <div className="idcard-details-container">
                  ...
                  <div className="idcard-detail-row">
                    ...
                    <div className="idcard-detail-text">
                      ...
                      <div className="design_name">{profile.company_name ? `${profile.company_name}` : 'Shubh Bhoomi Real Estates'}</div>
                    </div>
                  </div>
