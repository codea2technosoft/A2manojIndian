  ...
  const fetchVisits = async (page = 1) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/associate-advance-payment-list?${query}`,
        {
          method: "GET",
        ...
        <div className="card shadow-sm">
          <div className="card-header d-flex justify-content-between align-items-center gap-2">
            <div className="titlepage">
              <h3 className="mb-0">Advance Payments</h3>
            </div>
          ...
          <div className="card-body">
            ...
            {showFilter && !isDesktop && (
              <form
                onSubmit={handleSearch}
                className="d-flex flex-wrap-mobile gap-2 align-items-center mb-3"
              >
                <input
                  type="text"
                  name="amount"
            ...
            {loading ? (
              ...
              <>
                      ...
                      visits.map((visit, index) => (
                        <tr key={visit.id}>
                          ...
                          <td className="table-cell-remark">
                            {toSentenceCase(visit.description)}
                          </td>
                        </tr>
                      ))
                    )}
                ...
                {/* Updated Pagination - Only show when there are records */}
                {visits.length > 0 && (
