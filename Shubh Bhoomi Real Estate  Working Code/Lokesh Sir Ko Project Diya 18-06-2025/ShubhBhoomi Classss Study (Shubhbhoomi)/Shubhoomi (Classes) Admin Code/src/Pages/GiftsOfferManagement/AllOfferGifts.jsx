  ...
  const toggleTeamOfferStatus = async (id, currentStatus) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/self_offer_manage_status`, {
        ...
        body: JSON.stringify({
          id: id,
          self_offer_manage_status: newStatus,
        }),
      });
    ...
    <div className="padding_15">
      <div className="userlist mb-5">
        <div className="card shadow-sm">
          <div className="card-header d-flex flex-wrap-mobile justify-content-between align-items-center gap-2">
                      ...
                      <tr key={item.id}>
                        ...
                        <td>
                          ...
                          >
                            ...
                            <Form.Check
                              type="switch"
                              id={`offer-switch-${item.id}`}
                              checked={item.self_offer_manage_status === 1}
                              disabled={updatingStatusId === item.id}
