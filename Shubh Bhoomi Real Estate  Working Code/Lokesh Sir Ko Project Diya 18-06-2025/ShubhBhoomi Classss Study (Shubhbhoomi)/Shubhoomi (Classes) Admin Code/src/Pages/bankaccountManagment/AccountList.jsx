    ...
    <>
      <div className="card mt-2">
        ...
        {isFilterActive && (
          <div className="card-body pb-0">
            <Form
              className="d-flex gap-2 flex-wrap-mobile"
                        ...
                        {visit.status === "pending" && (
                          <div className="d-flex gap-2">
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleStatusAction(visit.id, "success")
                              }
                            >
                              Approve
                            </Button>
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleStatusAction(visit.id, "reject")
                              }
                            >
                              Reject
                            </Button>
      ...
      <Modal show={showConfirmModal} onHide={() => setShowConfirmModal(false)}>
        ...
        <Modal.Body>
          ...
          {selectedAction === "success" ? "approve" : "reject"} this account?
        </Modal.Body>
        <Modal.Footer>
          <Button
            variant="secondary"
          ...
          <Button
            variant={selectedAction === "success" ? "success" : "danger"}
