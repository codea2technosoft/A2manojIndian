  ...
  const EmptyState = () => (
    <>
      <Table striped bordered hover responsive>
        ...
        <tbody>
          <tr>
            {isNewStatusPage() && <td colSpan="1"></td>}
            <td colSpan={isNewStatusPage() ? 18 : 17} className="text-center py-5">
              <div className="empty-state-container">
                <svg 
                  ...
                  style={{ margin: '0 auto 20px', color: '#6c757d' }}
                >
                ...
                {/* <p className="text-muted">
                  {Object.values(filters).some(val => val && val !== "") 
                    ...
                    : "Click the 'Upload CSV' button to add leads."}
                </p> */}
                {Object.values(filters).some(val => val && val !== "") && (
                  <Button 
    ...
    <div className="card mt-2">
      <div className="card-header flex-wrap-mobile d-flex justify-content-between align-items-md-center gap-2">
        ...
        <div className="d-flex gap-2 flex-wrap">
          ...
          <Button variant="primary" className="d-flex gap-2 align-items-center fw-bold" onClick={handleDownloadExcel}>
