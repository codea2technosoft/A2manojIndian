...
function AssociatesBirthdayLists() {
  ...
  const fetchBirthdayList = async (page = 1) => {
    setLoading(true);
    setError(null);
    ...
    <>
      <div className="card mt-2">
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex gap-2">
              <button
                className={`filter-toggle-btn btn border border-1 ${isFilterActive ? "active" : ""}`}
        ...
        <div className="card-body">
          {isFilterActive && (
            <div className="d-flex gap-3 mb-3 mt-2 flex-wrap align-items-end">
              {/* <div className="form-group" style={{ flex: "1", minWidth: "200px" }}>
                <label className="form-label">Birth Date (DD-MM)</label>
                <div className="input-group">
                  <DatePicker
                    selected={searchDate}
                  ...
                  <tr>
                    <td colSpan="6" className="text-center">
                      {(filterInput || searchDate || fromDate || toDate) ?
                        `No birthdays found for selected filters` :
          ...
          {totalPages > 1 && (
            <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap-mobile gap-2">
