...
function CreateProject() {
  ...
  return (
    <>
      <div className="justify-content-center formselectnewdesign mt-2">
        <div className="card">
                ...
                <Col md={6}>
                  <Form.Group className="mb-3" controlId="amenities">
                    ...
                    <Dropdown className={errors?.amenities ? 'is-invalid' : ''}>
                      <Dropdown.Toggle variant="transparent" id="dropdown-amenities" className="w-100 text-start border">
                        {amenities.length > 0
