      ...
      <div className="adminlogin">
        <div className="d-flex login_form align-items-center">
          {/* <div className="quotes">
            <h2>Welcome to Shubh Bhoomi Real Estates</h2>
          ...
          <div className="login-wrapper">
            <div className="form_design">
              ...
              <form onSubmit={handleLogin} noValidate className="login-form text-start">
                ...
                <div className="form-group">
                  ...
                  <div style={{ position: "relative" }}>
                    <input
                      ...
                      className={` h-56-px ${error.password ? "error-input" : ""
                        }`}
                      name="password"
                      id="password"
                      value={password}
