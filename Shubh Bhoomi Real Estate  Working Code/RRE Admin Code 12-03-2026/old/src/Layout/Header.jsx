...
//       <div className="d-flex justify-content-between px-2 w-100 gap-1">
...
//                           <p className="mb-1 d-none d-md-block">
//                             Wallet Ledger
//                           </p>
//                           <h3 className="m-0 fw-normal text-success"></h3>
//                         </div>
//                       </div>
//                     </Link>
//                   </div>
...
//           {showInstall && (
//             <button onClick={handleInstallClick} className="pwabutton">
//               Install App
//             </button>
//           )}
//           <div className="d-xl-block position-relative">
//             <div
//               className="allheader border-0"
...
function Header({ onToggleSidebar }) {
  ...
  const fetchProfile = async () => {
    try {
      ...
      // 🔴 Agar name nahi hai toh email se pehla part le lo
      let userName = data.data.name;
      if (!userName || userName === "") {
        const email = data.data.email;
        if (email) {
          // Email se @ se pehle ka part (example: nks@gmail.com se "nks")
        ...
        <div className="linksmode">
          ...
          <div className="profilie" ref={dropdownRef}>
            <div className="profile-header" onClick={toggleDropdown}>
              ...
              <div className="name desktop_device">{name || userEmail?.split('@')[0] || "User"}</div>
              <div
                className={`arrowprofile transition-transform duration-300 ${dropdownOpen ? "rotate-180" : ""}`}
              >
                <IoIosArrowDown />
              ...
              <div className="profile-dropdown">
                <div className="dropdown-item mobile_device">
                  <div className="d-flex gap-2 align-items-center">
                    ...
                    <div className="name">{name || userEmail?.split('@')[0] || "User"}</div>
                  </div>
                </div>
                <div
                  className="dropdown-item d-flex align-items-center gap-2"
      ...
      <Modal show={showProfileModal} onHide={handleCloseProfileModal} centered>
        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" controlId="userNameDisplay">
              <Form.Label>Name</Form.Label>
              <Form.Control type="text" value={name || userEmail?.split('@')[0] || "User"} readOnly />
            </Form.Group>
            <Form.Group className="mb-3" controlId="userEmailDisplay">
              <Form.Label>Email</Form.Label>
              <Form.Control type="text" value={userEmail} readOnly />
