...
function AllLoanList() {
  ...
  const handleEditLead = async (id) => {
    ...
    if (leadData) {
      setEditFormData({
        ...
        employeeProof_bussinessRegistration: leadData.employeeProof_bussinessRegistration || "",
        bank_statement: leadData.bank_statement || "",
        bank_statement_current_account: leadData.bank_statement_current_account || "",
  ...
  const validateForm = () => {
    ...
    if (editFormData.adhar_number && !/^\d{12}$/.test(editFormData.adhar_number)) {
      errors.adhar_number = 'Aadhar number must be 12 digits';
      isValid = false;
    }

    if (editFormData.pan_card_number && !/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/.test(editFormData.pan_card_number)) {
    ...
    if (editFormData.require_loan_amount && isNaN(editFormData.require_loan_amount)) {
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success == '1') {
        showCustomMessageModal("Success", "Lead updated successfully!", "success");
  ...
  const handleStatusUpdate = async (id, newStatus) => {
    ...
    try {
      ...
      if (result.success == "1") {
        ...
        showCustomMessageModal("Error", result.message || "Somthing Went Wrong", "error");
      }
  ...
  const handleDeleteLead = async () => {
    try {
      ...
      fetchLeads(currentPage, searchQuery);
      showCustomMessageModal("Success", "Lead deleted successfully!", "success");
    } catch (error) {
  ...
  return (
    <div className="userlist allloanlistnew mt-2">
      <div className="card shadow-sm">
        ...
        <div className="card-body">
          <div className="d-flex gap-2 align-items-center mb-3 justify-content-between">
            <div className="d-none d-md-block">
              <div className="d-flex gap-2 align-items-center">
                ...
                <div className="form_design">
                  <button
                    type="button"
                    className="submit_button btn bg-white text-white"
                ...
                <tbody>
                  {leads && leads.map((lead, index) => (
                    <tr key={lead.id}>
                      ...
                      <td>
                        {lead.customer_name
                          ? lead.customer_name.charAt(0).toUpperCase() + lead.customer_name.slice(1).toLowerCase()
                          : ''}
                      </td>
                      ...
                      <td>
                        {lead.category
                          ? lead.category.charAt(0).toUpperCase() + lead.category.slice(1).toLowerCase()
                          : ''}
                      </td>

                      <td>
                        {lead.service
                          ? lead.service.charAt(0).toUpperCase() + lead.service.slice(1).toLowerCase()
                          : ''}
                      </td>
                      ...
                      <td>
                        <select
                          ...
                          disabled={loading}
                        >
                          {["new", "documentPending", "sanctionInProcess", "sanctioned", "disbursementInProcess", "disbursed", "propertyOriginalDocumentPending","rejected","notintersted"].map((status) => (
                            <option
                              key={status}
                              value={status}
                              className={getStatusBadgeClass(status)}
      ...
      <Modal show={showViewModal} onHide={() => setShowViewModal(false)} size="lg">
        ...
        <Modal.Body>
          {selectedLead && (
            <div className="row">
              <div className="col-md-6 mb-3"><strong>Customer Name:</strong> {selectedLead.customer_name}</div>
              <div className="col-md-6 mb-3"><strong>Mobile:</strong> {selectedLead.mobile}</div>
              <div className="col-md-6 mb-3"><strong>Category:</strong> {selectedLead.category}</div>
              <div className="col-md-6 mb-3"><strong>Service:</strong> {selectedLead.service}</div>
              <div className="col-md-6 mb-3"><strong>Income Source:</strong> {selectedLead.income_source}</div>
              <div className="col-md-6 mb-3"><strong>Adhar Number:</strong> {selectedLead.adhar_number}</div>
              <div className="col-md-6 mb-3"><strong>Pan Card Number:</strong> {selectedLead.pan_card_number}</div>
              <div className="col-md-6 mb-3"><strong>State:</strong> {selectedLead.state_name}</div>
              <div className="col-md-6 mb-3"><strong>City:</strong> {selectedLead.city_name}</div>
              <div className="col-md-6 mb-3"><strong>Monthly Income:</strong> {selectedLead.monthly_income}</div>
              <div className="col-md-6 mb-3"><strong>Monthly EMI:</strong> {selectedLead.monthly_emi}</div>
              <div className="col-md-6 mb-3"><strong>CIBIL Score:</strong> {selectedLead.cibil_score}</div>
              <div className="col-md-6 mb-3"><strong>CIBIL Value:</strong> {selectedLead.cibil_score_value}</div>
              <div className="col-md-6 mb-3"><strong>Required Loan:</strong> {selectedLead.require_loan_amount}</div>
              <div className="col-md-6 mb-3"><strong>Pincode:</strong> {selectedLead.pincode}</div>
              <div className="col-md-6 mb-3"><strong>Location:</strong> {selectedLead.location}</div>
                  ...
                  {selectedLead.adhar_front_image && (
                    <div className="mb-3">
                      ...
                      <button
                        ...
                        onClick={() => {
                          window.open(`${imageAPIURL}/loanlead/${selectedLead.adhar_front_image}`, '_blank');
                        }}
                      >
                        Download
                      </button>
                  ...
                  {selectedLead.adhar_back_image && (
                    <div className="mb-3">
                      ...
                      <button
                        ...
                        onClick={() => {
                          window.open(`${imageAPIURL}/loanlead/${selectedLead.adhar_back_image}`, '_blank');
                        }}
                      >
                        Download
                      </button>
                  ...
                  {selectedLead.pan_card_image && (
                    <div className="mb-3">
                      ...
                      <button
                        className="btn btn-primary"
                        onClick={() => {
                          window.open(`${imageAPIURL}/loanlead/${selectedLead.pan_card_image}`, '_blank');
                        }}
                      >
                        Download
                      </button>
        ...
        <Modal.Footer>
          <Button variant="danger" onClick={() => setShowViewModal(false)}>Close</Button>
        </Modal.Footer>
      </Modal>


      {/* Edit Modal */}
      <Modal show={showEditModal} onHide={() => setShowEditModal(false)} size="lg" className="formselectnewdesign">
        <Modal.Header closeButton>
            ...
            <Row>
              ...
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="adhar_front_image" onChange={handleEditFileChange} accept="image/*" />
                  {editFormData.adhar_front_image && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.adhar_front_image}`} target="_blank" rel="noopener noreferrer">
                        View Current Image
                      </a>
                    </div>
                  )}
              ...
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="adhar_back_image" onChange={handleEditFileChange} accept="image/*" />
                  {editFormData.adhar_back_image && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.adhar_back_image}`} target="_blank" rel="noopener noreferrer">
                        View Current Image
                      </a>
                    </div>
                  )}
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="pan_card_image" onChange={handleEditFileChange} accept="image/*" />
                  {editFormData.pan_card_image && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.pan_card_image}`} target="_blank" rel="noopener noreferrer">
                        View Current Image
                      </a>
                    </div>
                  )}
              ...
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="current_residence_proof" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.current_residence_proof && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.current_residence_proof}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="permanent_address_proof" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.permanent_address_proof && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.permanent_address_proof}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
              ...
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  <Form.Label>Employee/Business Registration Proof (PDF)</Form.Label>
                  <Form.Control type="file" name="employeeProof_bussinessRegistration" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.employeeProof_bussinessRegistration && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.employeeProof_bussinessRegistration}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="bank_statement" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.bank_statement && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.bank_statement}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
              ...
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  <Form.Label>Bank Statement - Current Account (PDF)</Form.Label>
                  <Form.Control type="file" name="bank_statement_current_account" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.bank_statement_current_account && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.bank_statement_current_account}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="gst_return" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.gst_return && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.gst_return}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
              ...
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="property_paper" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.property_paper && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.property_paper}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="salary_slip" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.salary_slip && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.salary_slip}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
              ...
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="itr" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.itr && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.itr}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="position-relative mb-3">
                  ...
                  <Form.Control type="file" name="form16" onChange={handleEditFileChange} accept=".pdf" />
                  {editFormData.form16 && (
                    <div className="buttonviewallimages">
                      <a href={`${imageAPIURL}/loanlead/${editFormData.form16}`} target="_blank" rel="noopener noreferrer">
                        View Current PDF
                      </a>
                    </div>
                  )}
      ...
      <Modal show={showMessageModal} onHide={closeCustomMessageModal} centered>
        <Modal.Header closeButton className={`border-top border-4 ${messageModalContent.type === "success" ? "border-success" : messageModalContent.type === "error" ? "border-danger" : "border-warning"
          }`}>
        ...
        <Modal.Footer className="justify-content-center">
          <Button variant={
            messageModalContent.type === "success" ? "success" : messageModalContent.type === "error" ? "danger" : "primary"
          } onClick={closeCustomMessageModal}>OK</Button>
        </Modal.Footer>
      </Modal>
    </div>
  );
