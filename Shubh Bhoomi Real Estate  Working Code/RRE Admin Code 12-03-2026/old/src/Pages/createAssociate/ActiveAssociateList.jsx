...
function ActiveAssociateList() {
  ...
  const exportAllToExcel = async () => {
    try {
      ...
      let url = `${API_URL}/active-associate-excel-download`;
      const response = await fetch(url, {
        headers: {
          Authorization: `Bearer ${token}`,
          Accept: "text/csv"
              ...
              <div className="d-flex gap-2">
                ...
                <div className="createnewadmin">
                  <Link to="/create-associate" className="btn btn-success d-inline-flex align-items-center">
                    <FaPlus className="me-2" /> New Associate
                  </Link>
                </div>
              </div>
            </div>
                    ...
                    <tr key={associate.id}>
                      ...
                      <td>
                        {associate.parent_name
                          ? associate.parent_name.charAt(0).toUpperCase() + associate.parent_name.slice(1).toLowerCase()
                          : "-"}
                      </td>
                      ...
                      <td>
                        {associate.date
                          ? (() => {
                            const [day, month, year] = associate.date.split("-");
...
export default ActiveAssociateList;