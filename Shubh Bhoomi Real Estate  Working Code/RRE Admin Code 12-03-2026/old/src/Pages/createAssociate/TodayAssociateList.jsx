...
function AllAssociateList() {
  ...
  const fetchAssociates = async (page = 1, username = "", mobile = "", location = "") => {
    ...
    try {
      ...
      let url = `${API_URL}/today-associate-list?page=${page}&limit=10`;
                      ...
                      <td>
                        <div className="dropdown">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li className="dropdown-item">
                              <button
                                variant={associate.status === "active" ? "danger" : "success"}
                ...
                <Form.Group className="mb-3" controlId="currentParentId">
                  ...
                  <Form.Text className="text-muted">
                    <span style={{ color: "red" }}>
                      This is the old parent ID from the previous update history.
                    </span>
