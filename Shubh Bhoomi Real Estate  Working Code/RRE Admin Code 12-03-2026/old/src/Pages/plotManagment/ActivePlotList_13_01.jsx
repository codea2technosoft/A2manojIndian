          ...
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex gap-2">
              ...
              <div className="createnewadmin">
                <Link to="/create-plot" className="fw-bold btn btn-success d-flex align-items-center">
                ...
                {plots?.length > 0 ? (
                 plots.map((plot, index) => (
                  ...
                  <td>{(currentPage - 1) * 10 + index + 1}</td>
                      ...
                      {/* <td>₹{plot.area_sqyd * plot.rate}</td> */}
        ...
        <Modal.Body>
          <Form onSubmit={handleUpdatePlot}>
            ...
            <div className="row">
              ...
              <div className="col-md-6">  <Form.Group className="mb-3" controlId="editPlotAddress">
