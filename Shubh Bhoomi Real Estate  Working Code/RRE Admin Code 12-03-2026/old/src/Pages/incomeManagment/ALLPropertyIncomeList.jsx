        ...
        <Row className="mb-3">
          <Col md={6}>
            <div className="p-3 bg-light rounded shadow-sm">
              <h5 className="text-muted"><strong>Total Commissions</strong></h5>
              <h3 className="text-success">{totalCommission.toLocaleString("en-IN")}</h3>
            </div>
          </Col>
          <Col md={6}>
            <div className="p-3 bg-light rounded shadow-sm">
              <h5 className="text-muted"><strong>Total Records</strong></h5>
                  ...
                  <tr key={record.income_id}>
                    ...
                    <td>
                      <Button
                        size="sm"
                        variant="info"
                        onClick={() => navigate(`/parent-commission/${record.income_id}`)}
                      >
                        <FaEye />
                      </Button>
                    </td>
