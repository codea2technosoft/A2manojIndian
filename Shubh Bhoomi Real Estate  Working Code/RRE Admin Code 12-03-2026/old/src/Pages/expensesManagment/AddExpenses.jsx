...
function AddExpenses() {
    ...
    const shouldShowMobileNumberField = () => {
        ...
        return formData.category_id === "1" ||
            ...
            (selectedCategory?.name === "Rewards Paid" && formData.category_type === "dr") || 
            (selectedCategory?.name === "Commission Difference" && formData.category_type === "dr") || 
            (selectedCategory?.name === "Fuel Convince Paid" && formData.category_type === "dr") || 
            (selectedCategory?.name === "Salary Paid" && formData.category_type === "dr") ||
            (selectedCategory?.name === "Royalty Paid" && formData.category_type === "dr") ||
            (selectedCategory?.name === "TDS Amount Received" && formData.category_type === "cr");
    };
    ...
    const handleFormChange = (e) => {
        ...
        setFormData((prevData) => {
            ...
            if (name === "category_id") {
                ...
                const prevSelectedCategory = categories.find((cat) => cat.id.toString() === prevData.category_id);
                if (prevSelectedCategory && isCommissionCategory() && !isCommissionCategory()) {
                    newData.project_id = "";
                    newData.plot_id = "";
                    setSelectedPlotArea(null);
                    setPerUnitAmount("");
                                            ...
                                            <>
                                                ...
                                                <Col md={6}>
                                                    <Form.Group className="mb-3">
                                                        <Form.Label>
                                                            Select Project 
                                                            {isProjectPlotMandatory() && <span className="text-danger">*</span>}
                                                        </Form.Label>
                                                        <Form.Control
                                                            as="select"
                                                            name="project_id"
                                                        ...
                                                        {isProjectPlotMandatory() && !formData.project_id && (
                                                ...
                                                {isCommissionCategory() && formData.plot_id && selectedPlotArea && (
                                                    <>
                                                        <Col md={6}>
                                                            <Form.Group className="mb-3">
