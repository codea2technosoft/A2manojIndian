...
function OnlineCreditList() {
  // State for cash/credit transactions
  ...
  const [searchType, setSearchType] = useState(""); // cash or credit or online
  ...
  // Fetch cash/credit/online transactions
  const fetchTransactions = async (page = 1, type = "", date = "") => {
    ...
    try {
      ...
      let url = `${API_URL}/credit-online-details?page=${page}&limit=10`;
  ...
  // Get badge for type (cash/credit/online)
  const getTypeBadge = (type) => {
    switch(type) {
      case 'cash':
        return { text: 'Cash', className: 'bg-info' };
      case 'credit':
        return { text: 'Credit', className: 'bg-warning text-dark' };
      case 'online':
        ...
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between">
            <div className="titlepage">
              <h3>Online Credit List Details</h3>
              <p className="text-muted mb-0">Total Records: {totalRecords}</p>
            </div>
