  ...
  const fetchPendingBooking = async (page = 1, params = {}) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || "Failed to fetch Pending Booking.");
      }
      ...
      showCustomMessageModal("Error", err.message || "An unexpected error occurred while fetching Pending Booking.", "error");
    } finally {
      setLoading(false);
    }
  };
                          ...
                          <ul className="dropdown-menu" aria-labelledby={`dropdownMenuButton-${pendingbooked.id}`}>
                            ...
                            <li className="dropdown-item">
                              <button
                                ...
                                onClick={() => handleUpdateStatusClick(pendingbooked.id, "booked_pending")}
                              >
                                Booked Pending
                              </button>
                            </li>
              ...
              <div className="modal-footer justify-content-end">
                {messageModalContent.confirmAction ? (
                  <>
                    ...
                    <Button
                      variant={messageModalContent.type === "success" ? "success" : "primary"}
                      onClick={() => {
                        messageModalContent.confirmAction();
