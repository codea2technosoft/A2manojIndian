...
import { Button, Table, Pagination, Row, Col, Container, Spinner } from "react-bootstrap";
...
function WithdrawlStatusList() {
  ...
  const handleDownloadFilteredExcel = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/download-withdrawal-success-excel?${params}`, {
        method: "GET",
        headers: {
    ...
    <>
      <div className="card mt-2">
        ...
        <div className="card-body">
          ...
          {/* Desktop Search and Status Filters */}
