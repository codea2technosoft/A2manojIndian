...
function SRVoicePresidentRewards() {
  ...
  const fetchLedger = async (page = 1) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/senior-vice-president-rewards-lists?${params}`, {
        method: "GET",
        ...
        <div className="card shadow-sm">
          <div className="card-header d-flex justify-content-between align-items-center gap-2">
            <div className="titlepage">
              <h3 style={{ whiteSpace: 'wrap' }}>20001 SQYD From Your Team Sr.Voice President Achievements Lists</h3>
            </div>
