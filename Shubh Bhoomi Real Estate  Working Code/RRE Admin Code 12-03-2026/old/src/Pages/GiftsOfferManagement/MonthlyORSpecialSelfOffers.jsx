...
function MonthlyORSpecialSelfOffers() {
  ...
  const fetchLedger = async (page = 1) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/gift-eligibility-list?${params}`, {
        method: "GET",
  ...
  const handleDownloadFilteredExcel = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "Please Check Entered From Date & To Date For Downloading Self, Monthly Offers or Special Offers Lists Report.",
      });
    }
  };
        ...
        <div className="card shadow-sm">
          <div className="card-header d-flex justify-content-between align-items-center gap-2">
            <div className="titlepage">
              <h3 style={{ whiteSpace: 'wrap' }}>Self, Monthly Offers or Special Offers Lists</h3>
            </div>
              ...
              <>
                <Table striped bordered hover responsive>
                  ...
                  <tbody>
                    {ledger.length === 0 ? (
                      <tr>
                        <td colSpan="8" className="text-center py-4 text-danger fw-bold">
                          
                          <p className="text-muted mb-3 text-danger fw-bold">
...
export default MonthlyORSpecialSelfOffers;