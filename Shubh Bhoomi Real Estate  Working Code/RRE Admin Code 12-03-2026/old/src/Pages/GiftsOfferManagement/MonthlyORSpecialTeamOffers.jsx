...
function MonthlyORSpecialTeamOffers() {
  ...
  const fetchLedger = async (page = 1) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/gift-team-eligibility-list?${params}`, {
        method: "GET",
  ...
  const handleDownloadFilteredExcel = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "Please Check Entered From Date & To Date For Downloading Teams Monthly Offers or Special Offers Report.",
      });
    }
  };
        ...
        <div className="card shadow-sm">
          <div className="card-header d-flex justify-content-between align-items-center gap-2">
            <div className="titlepage">
              <h3 style={{ whiteSpace: 'wrap' }}>Teams Monthly Offers or Special Offers Lists</h3>
            </div>
                    ...
                    {ledger.length === 0 ? (
                      ...
                      ledger.map((item, index) => (
                        <tr key={item.user_id || index}>
                          ...
                          <td>{item.total_area_achieved || "-"}</td>
...
export default MonthlyORSpecialTeamOffers;