...
function VoicePresidentRewards() {
  ...
  const fetchLedger = async (page = 1) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/vice-president-rewards-lists?${params}`, {
        method: "GET",
        ...
        <div className="card shadow-sm">
          <div className="card-header d-flex justify-content-between align-items-center gap-2">
            <div className="titlepage">
              <h3 style={{ whiteSpace: 'wrap' }}>10001 SQYD From Your Team Vice President Royalty Achievements Lists</h3>
            </div>
