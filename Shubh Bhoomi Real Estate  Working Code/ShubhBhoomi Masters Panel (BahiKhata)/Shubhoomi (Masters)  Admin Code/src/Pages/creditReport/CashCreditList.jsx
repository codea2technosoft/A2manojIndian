...
function CashCredit() {
  ...
  const [searchType, setSearchType] = useState(""); // cash or credit
  ...
  // Fetch cash/credit transactions
  const fetchTransactions = async (page = 1, type = "", date = "") => {
    ...
    try {
      ...
      let url = `${API_URL}/credit-cash-details?page=${page}&limit=10`;
        ...
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between">
            <div className="titlepage">
              <h3>Cash Credit List Details</h3>
