    ...
    return (
      <div className="parent-chain-container">
        ...
        <div className="chain-flow">
          {chainData.parents.map((parent, index) => (
            <div key={parent.id} className="chain-item-wrapper">
              ...
              <div className="chain-item card shadow-sm mb-3">
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-start">
                    <div className="flex-grow-1">
                      <div className="d-flex align-items-center mb-2">
                        <strong className="fs-5 me-2">{parent.username
        ...
        <div className="text-center mb-4">
          <div className="current-user-card p-3 bg-primary text-white rounded shadow">
