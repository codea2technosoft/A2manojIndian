...
function AssociatesBirthdayLists() {
  ...
  const fetchBirthdayList = async (page = 1, filterDate = null) => {
    ...
    try {
      ...
      let url = `${API_URL}/birthday-list-associate?page=${page}&limit=${perPage}`;
      if (filterDate) {
        const formattedDate = typeof filterDate === 'string'
          ? filterDate
      ...
      if (data.success === "1") {
        ...
        showCustomMessageModal("Error", data.message || "Failed to fetch birthday list.", "error");
        setBirthdays([]);
        setTotalPages(1);
        setCurrentPage(1);
        setTotalRecords(0);
        ...
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between">
            <div className="titlepage">
              <h3>Associates Birthday Lists</h3>
            </div>
            ...
            <div className="d-block d-md-none">
              <button
                className={`filter-toggle-btn btn btn ${isFilterActive ? "btn-secondary" : "btn-outline-secondary"
                  }`}
                onClick={handleToggle}
              >
                {isFilterActive ? <MdFilterAltOff /> : <MdFilterAlt />}
          ...
          {isFilterActive && (
            <div className="d-flex gap-2 mb-3 mt-2 flex-wrap align-items-end">
              <div className="form-group" style={{ flex: "1", minWidth: "250px" }}>
                <label className="form-label">Filter by Birth Date (DD-MM)</label>
                <div className="input-group">
                  <DatePicker
                    selected={searchDate}
                  ...
                  <tr>
                    <td colSpan="6" className="text-center">
                      {(searchDate || filterInput) ?
                        `No birthdays found for ${filterInput || formatDateForAPI(searchDate)}` :
          ...
          {totalPages > 1 && (
            <div className="d-flex justify-content-between align-items-center mt-3">
              <div className="text-muted">
                ...
                {Math.min(currentPage * perPage, totalRecords)} of {totalRecords} birthdays
              </div>
              <div>
                <Pagination>
                  <Pagination.Prev
...
export default AssociatesBirthdayLists;