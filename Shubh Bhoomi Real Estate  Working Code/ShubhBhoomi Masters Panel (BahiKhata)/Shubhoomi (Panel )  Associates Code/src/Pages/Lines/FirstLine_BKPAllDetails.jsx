...
function FirstLine() {
  ...
  const fetchLineData = async (page = 1) => {
    ...
    try {
      ...
      const url = `${API_URL}/line-one-details-associate?page=${page}&limit=${LIMIT}`;
  ...
  const handleExportAllToExcel = async () => {
    ...
    try {
      ...
      const summaryData = [
        ...
        [],
        ['NOTE', 'This file contains all property records for all users in First Line']
      ];
      ...
      const date = new Date();
      const fileName = `All_Users_Property_Records_${date.getFullYear()}-${(date.getMonth() + 1).toString().padStart(2, '0')}-${date.getDate().toString().padStart(2, '0')}.csv`;
        ...
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between gap-2">
            <div className="titlepage">
              <h3>{lineData.line_info?.line_name || "First Line"} Details</h3>
            </div>
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              <div className="d-md-block d-none d-sm-none">
                <div className="d-flex gap-2">
                  {/* YEH HAI EXPORT ALL BUTTON - Back button ke paas */}
                      ...
                      <tbody>
                        {paginatedUsers.map((user, index) => (
                          <tr key={user.id}>
                            ...
                            <td>
                              <div className="d-flex gap-2">
                                {/* Only View Details Button - Excel button hata diya */}
                                <button
                                  className="btn btn-sm btn-info"
                                  disabled={!user?.id}
                                  onClick={() => navigate(`/lines-details/${user?.id}`)}
                                  title="View Details"
                                >
                                  <FaEye />
                                </button>
