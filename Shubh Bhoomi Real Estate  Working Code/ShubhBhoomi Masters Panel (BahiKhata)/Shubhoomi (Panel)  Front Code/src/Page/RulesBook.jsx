...
const RulesBook = () => {
    ...
    const fetchPreviousPapers = async () => {
        try {
            ...
            setdownloadpdf(responseData.rre_rules_book);
            console.warn(responseData.rre_rules_book);
        ...
        <section className="course paper">
            <div className="d-none d-md-block">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <h3 class="main_headin-2 "> Download Rules Book</h3>
            ...
            <div className="card">
                <div className="card-header d-flex justify-content-between align-items-center">
                    <div className="card-title"><strong>Rules Book</strong></div>
                    <div >
                        <a
