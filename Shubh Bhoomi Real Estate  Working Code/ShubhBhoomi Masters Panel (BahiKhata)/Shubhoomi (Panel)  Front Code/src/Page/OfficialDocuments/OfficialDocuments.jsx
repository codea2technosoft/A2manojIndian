                    ...
                    <div className="pt-70 pb-70">
                        <div className="desktop-tabs">
                            <div className='d-flex tab_button_design  '>
                                ...
                                <button className={`tab btn btn_tab_dseign ${tabs === 2 ? "active" : ''}`} onClick={() => handletab(2)}>Download Shubh Bhoomi Plans</button>
                        ...
                        <div className="mobile-tabs">
                            <select value={tabs} className='form-select mb-2' onChange={(e) => handletab(Number(e.target.value))}>
                                ...
                                <option value={2}>Download Shubh Bhoomi Plans</option>
