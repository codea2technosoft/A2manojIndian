                  ...
                  <>
                    {reportData.map((item) => (
                      <React.Fragment key={item.uid || item.id}>
                        ...
                        >
                          ...
                          <td>
                            <span className={getColorClass(item.downline_pl)}>
                              {formatNumber(item.downline_pl)}
                            </span>
                          </td>
                          <td>
                            <span>
                              {formatNumber(
                                item.agent_commission || item.agent_comm,
                              )}
                            </span>
                          </td>
                          <td>
                            <span className={getColorClass(item.upline_pl)}>
                              {formatNumber(item.upline_pl)}
                            </span>
                          </td>
                        </tr>
                        {item.children &&
                                    ...
                                    {item.children.map((child) => (
                                      <tr key={child.admin_id || child.uid}>
                                        ...
                                        <td>
                                          ...
                                          >
                                            {formatNumber(child.downline_pl)}
                                          </span>
                                        </td>
                                        <td>
                                          <span>
                                            {formatNumber(
                                              child.agent_commission ||
                                                child.agent_comm,
                                            )}
                                          </span>
                                        </td>
                    ...
                    {totals && (
                      <tr className="total-table-balance-none">
                        ...
                        <td>
                          <strong>
                            <span className={getColorClass(totals.downline_pl)}>
                        ...
                        <td>
                          <strong>
                            {formatNumber(
                              totals.agent_commission || totals.agent_comm,
                            )}
                          </strong>
                        </td>
                        <td>
                          <strong>
                            <span className={getColorClass(totals.upline_pl)}>
