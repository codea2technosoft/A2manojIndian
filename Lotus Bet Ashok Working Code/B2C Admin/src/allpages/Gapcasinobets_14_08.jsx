...
function Internationalreport() {
    ...
    const renderPagination = () => {
        ...
        return (
            <div className="bottom-pagination mb-2 d-flex justify-content-center align-items-center">
                <ul className="pagination mb-0 gap-1">

                    <li className={`previous p-0 ${pagination.current_page === 1 ? "disabled" : ""}`}>
                    ...
                    <li
                        className={`p-0 next ${pagination.current_page === pagination.total_pages ? "disabled" : ""
                            }`}
                    >
                        <Link onClick={() => handlePageChange(pagination.current_page + 1)}>
                            <FaChevronRight />
