...
// export default CurrentBetsdashboard;
...
const CurrentBetsdashboard = () => {
  ...
  // Define tabs configuration - Greyhound and Horse Racing after Casino
  const tabs = [
    { key: 'Exchange', label: 'Exchange' },
    { key: 'FancyBet', label: 'FancyBet' },
    { key: 'BookMaker', label: 'BookMaker' },
  ...
  // ✅ Get tab specific params - market_type empty for Greyhound and HorseRacing
  const getTabParams = (tabKey) => {
    const paramsMap = {
      'Exchange': { sport: '', market_type: '', bet_status: '' },
      'FancyBet': { sport: '4', market_type: 'fancy', bet_status: 'pending' },
      'BookMaker': { sport: '4', market_type: 'bookmaker', bet_status: 'pending' },
      'casino': { sport: '10', market_type: 'casino', bet_status: 'pending' },
      'Greyhound': { sport: '8', market_type: '', bet_status: 'pending' },
      'HorseRacing': { sport: '7', market_type: '', bet_status: 'pending' },
      'Toss': { sport: '', market_type: 'toss', bet_status: 'pending' },
      'Tie': { sport: '', market_type: 'tie', bet_status: 'pending' },
      'lottery': { sport: '', market_type: 'lottery', bet_status: 'pending' },
    };
  ...
  const fetchBets = async (tabKey) => {
    ...
    try {
      ...
      // ✅ Client-side filtering based on sport
      if (sport) {
