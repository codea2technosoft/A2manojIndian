...
function Cricket() {
  ...
  const matchlist = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        `https://cricketfancylive.shyammatka.co.in/get-match-odds-list?id=${marketId}&sport_id=${sportId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getfancylist = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        `https://cricketfancylive.shyammatka.co.in/get-fancy-list-guruji?id=${event_id}&sport_id=${sportId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
