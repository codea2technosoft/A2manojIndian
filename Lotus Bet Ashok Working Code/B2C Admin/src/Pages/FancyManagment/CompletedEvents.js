  ...
  const fetchEvents = async () => {
    try {
      ...
      if (response.data.data) {
        const completedEvents = response.data.data.filter(
          (event) => event.is_completed === 1,
        );
    ...
    <section>
      ...
      <div className="card">
        <div className="card-header d-flex justify-content-between align-items-center">
          ...
          <div>
            <button className="btn btn-light" onClick={fetchEvents}>
              Refresh
            </button>
            <button
                  ...
                  <tr key={game._id}>
                    ...
                    <td className="d-flex align-items-center gap-2">
                      ...
                      <select
                        ...
                        disabled={
                          updating === game._id || editableEventId !== game._id
                        } // ✅ only enable for current event
                        style={{ width: "120px" }}
                      >
