...
export default function AccountStatement() {
  ...
  return (
    <div className="card">
      {/* HEADER */}
      <div className="card-header d-flex justify-content-between gap-2 align-items-md-center flex-wrap-mobile">
        <h3 className="card-title mb-0">Admin Bet History</h3>
      ...
      <div className="card-body">
        ...
        <div className="d-flex justify-content-end align-items-center mt-3 gap-1">
          ...
          <button className="btn btn-outline-secondary">{page}</button>
