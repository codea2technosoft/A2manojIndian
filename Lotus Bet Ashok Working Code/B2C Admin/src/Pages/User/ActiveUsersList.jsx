    ...
    <div className="card">
      <div className="card-header d-flex justify-content-between align-items-center">
        ...
        <div className="gap-2 d-flex">
          <button className="btn btn-light" onClick={() => setFilter(!filter)}>
            <MdFilterListAlt /> Filter
          </button>
          <button className="btn btn-light" onClick={() => navigate("/all_users")}>
            <BsArrowLeft /> Back
          </button>
        </div>
      </div>
              ...
              users.map((user, index) => (
                <tr key={user._id}>
                  ...
                  <td className="d-flex gap-1 justify-content-center">
                    <button className="btn btn-sm btn-primary2" onClick={() => navigate(`/edituser/${user._id}`)}><FaEdit /></button>
         ...
         {pagination.totalPages > 1 && (
          <div className="card-footer d-flex justify-content-between align-items-center">
            <span className="text-muted small">
              ...
              {Math.min(pagination.page * pagination.limit, pagination.totalPages)}{" "}
