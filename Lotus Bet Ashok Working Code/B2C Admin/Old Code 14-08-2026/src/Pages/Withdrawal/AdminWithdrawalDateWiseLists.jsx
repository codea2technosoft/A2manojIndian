...
import { getAdminWithdrawlsitdateWise } from "../../Server/api"; // adjust path
...
const DepositReport = () => {
  ...
  const fetchReport = async () => {
    ...
    try {
      ...
      const result = await getAdminWithdrawlsitdateWise(params);
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <button
                              ...
                              onClick={() =>
                                navigate(
                                  `/admin_withdrawal_datewise_details/${item.date}`,
                                )
                              }
                            >
                              View
