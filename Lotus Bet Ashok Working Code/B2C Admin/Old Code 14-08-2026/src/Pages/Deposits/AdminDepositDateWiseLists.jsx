...
import { getAdminDepositListsByDate } from "../../Server/api"; // adjust path

const AdminDepositDatewiseList = () => {
  ...
  const fetchReport = async () => {
    ...
    try {
      ...
      const result = await getAdminDepositListsByDate(params);
      ...
      <div className="card">
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between">
            <h3 className="card-title text-white">Admin Withdraw Date List</h3>
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <button
                              ...
                              onClick={() =>
                                navigate(`/admin_deposit_detail/${item.date}`)
                              }
                            >
                              View
                            </button>
...
export default AdminDepositDatewiseList;
