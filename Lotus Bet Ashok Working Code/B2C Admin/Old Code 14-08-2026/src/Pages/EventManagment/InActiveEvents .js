...
function InActiveEvents() {
  ...
  return (
    <section>
      ...
      <div className="card">
        <div className="card-header flex-wrap-mobile gap-2 d-flex justify-content-between align-items-md-center">
          <h3 className="card-title">All InActive Event List</h3>
          {/* <div className="d-flex">
            <button className="btn btn-light" onClick={() => navigate("/active_events")}>
              ← Back
            </button>
