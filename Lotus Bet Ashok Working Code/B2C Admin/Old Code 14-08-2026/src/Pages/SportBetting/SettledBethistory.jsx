      ...
      <section>
        <div className="card">
          <div className="card-header flex-wrap-mobile d-flex justify-content-between align-items-md-center gap-2">
            <h3 className="card-title mb-0">Settled Bets History </h3>
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="d-flex flex-wrap gap-3 align-items-center">
                  ...
                  {filter && (
                    <div className=" mb-3 d-flex gap-2 align-items-center w-100 flex-wrap-mobile">
                      <div className="w-100">
                ...
                <div className="col-md-4">
                  <div className="card rounded">
                    <div className="card-body bg-success text-light">
                      ...
                      <h4 className="mb-0">
                        ₹{formatNumber(summary.total_win_amount)}
                      </h4>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="card rounded">
                    <div className="card-body bg-danger text-light">
                      ...
                      <h4 className="mb-0">
                        ₹{formatNumber(summary.total_loss_amount)}
                      </h4>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="card rounded">
                    <div className="card-body bg-info text-light">
                      ...
                      <h4
                        className={`mb-0 ${getProfitLossClass(summary.total_profit)}`}
                      >
            ...
            {fromDate && toDate && !loading && statementData.length > 0 && (
              <div className="mb-3">
                <small className="text-muted">
                  Showing data from{" "}
                  {new Date(fromDate).toLocaleDateString("en-IN")} to{" "}
                      ...
                      {statementData.map((item, index) => {
                        ...
                        return (
                          <tr key={item._id || index}>
                            ...
                            <td
                              className={`text-end fw-bold ${profitLossClass}`}
                            >
