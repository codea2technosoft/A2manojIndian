...
export const SubmitadminGeneralSettings = (data) =>
  API.post("/submit-admin-general-settings", data);

export const getAdminGeneralSetingsData = (payload) =>
  API.get("/get-admin-general-settings", { params: payload });
