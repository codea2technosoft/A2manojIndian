...
//     // Helper function to check if current path matches any of the given paths
//     // FIXED: More precise path matching to prevent overlapping
//     const isActivePath = (paths) => {
//         return paths.some(path => {
//             // Exact match
//             if (location.pathname === path) return true;
//             // For nested paths, ensure proper matching with trailing slash
...
//                         <li className={isActivePath(["/general-setting", "/transfer-agent", "/admin-general-settings"]) ? "active" : ""}>
//                             <Link to="/general-setting">Setting</Link>
//                         </li>

//                         {/* FIXED: Other dropdown with all child routes */}
//                         <li className={`dropdown ${
//                             isActivePath([
//                                 "/comming-soon",
//                                 "/slider_lists"
...
//                         {/* FIXED: Sport Management dropdown with Link instead of a */}
//                         <li className={`dropdown ${
//                             isActivePath([
//                                 "/sports",
//                                 "/cricket",
...
//                             >
//                                 <Link to="/sports">Sport Management</Link>
...
//                                 <li><Link to="/view_match">Declare Fancy Results</Link></li>
//                                 <li><Link to="/declare_result">Declare Match Results</Link></li>
//                                 <li><Link to="/declare_result_horsegreyhund">Declare Horse & Greyhound Results</Link></li>
//                             </ul>
//                         </li>
//                     </ul>
//                 </nav>
