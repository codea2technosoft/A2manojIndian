                    ...
                    <ul>
                        ...
                        <li className={`dropdown ${["/banking", "/settlement"].includes(location.pathname)
                            ...
                            <ul className={activeDropdown === "banking" ? "show" : ""}>
                                <li><Link to="/comming-soon">Banking D/W</Link></li>
                                <li><Link to="/comming-soon">Settlement</Link></li>
                            </ul>
                            {/* <ul className={activeDropdown === "banking" ? "show" : ""}>
                        ...
                        <li className={location.pathname === "/general-setting" ? "active" : ""}>
                            <div
                                className="mobile-title"
                        ...
                        <li className={location.pathname === "/sport" ? "active" : ""}>
                            ...
                            <ul className={activeDropdown === "Sport Management" ? "show" : ""}>
                                ...
                                {/* <li><a href="/slider_lists">Banner Manager</a></li>
