...
import { changeMasterPassword } from "../Server/api";
...
export default function Header({ depositPending = 0, withdrawPending = 0 }) {
  ...
  const validateAllFields = () => {
    ...
    const confirmPassError = validateConfirmPasswordField(
      confirmPassword,
      newPassword,
    );
          ...
          <ul>
            ...
            >
              ...
              >
                ...
                <span
                  className={`arrow ${activeDropdown === "report" ? "rotate" : ""}`}
                ></span>
              </div>
              <ul className={activeDropdown === "report" ? "show" : ""}>
                <li>
                  <Link to="/my-account-statement">Account Statement</Link>
                </li>
                <li>
                  <Link to="/pl-by-downline">Profit/Loss by Downline</Link>
                </li>
                <li>
                  <Link to="/match-profit-loss">Match Profit Loss</Link>
                </li>
                <li>
                  <Link to="/pl-by-market">Profit/Loss Report by Market</Link>
                </li>
                <li>
                  <Link to="/match-profit-loss">Profit/Loss Sports Wise</Link>
                </li>
                <li>
                  <Link to="/pl-report-by-player">
                    Profit/Loss Report by Player
                  </Link>
                </li>
                <li>
                  <Link to="/casino-profit-loss-by-date">
                    Casino Profit/Loss Report by Date
                  </Link>
                </li>
                <li>
                  <Link to="pl-aura-casino-bets">
                    Profit/Loss Aura Casino Bets
                  </Link>
                </li>
                <li>
                  <Link to="/pl-international-casino-bets">
                    Profit/Loss International Casino Bets
                  </Link>
                </li>
                <li>
                  <Link to="/pl-gap-casino-bets">
                    Profit/Loss Gap Casino Bets
                  </Link>
                </li>
              </ul>
            </li>
            ...
            <li
              className={location.pathname === "/bet-live-list" ? "active" : ""}
            >
              <Link to="/bet-live-list">BetListLive</Link>
            </li>

            <li
              className={location.pathname === "/riskmangement" ? "active" : ""}
            >
            ...
            <li
              className={`dropdown ${
                ["/Admindeposit", "/deposite_completed_history"].includes(
                  location.pathname,
                )
                  ? "active"
                  : ""
            ...
            >
              ...
              >
                ...
                <span
                  className={`arrow ${activeDropdown === "deposit" ? "rotate" : ""}`}
                ></span>
              </div>
              <ul className={activeDropdown === "deposit" ? "show" : ""}>
                <li>
                  <Link to="/Admindeposit">Wallet Deposit</Link>
                </li>
                <li>
                  <Link to="/deposite_completed_history">Deposit History</Link>
                </li>
              </ul>
            </li>

            <li
              className={`dropdown ${["/withdrawal_pending_Approve", "/withdrawal_complete"].includes(location.pathname) ? "active" : ""}`}
            >
              <div
                className="mobile-title"
              ...
              >
                ...
                <span
                  className={`arrow ${activeDropdown === "withdrawal" ? "rotate" : ""}`}
                ></span>
              </div>
              <ul className={activeDropdown === "withdrawal" ? "show" : ""}>
                ...
                <li>
                  <Link to="/withdrawal_complete">Withdrawal History</Link>
                </li>
              </ul>
            </li>
            ...
            <li
              className={`dropdown ${
                ["/banking", "/settlement"].includes(location.pathname)
                  ? "active"
                  : ""
              }`}
            >
              ...
              >
                ...
                <span
                  className={`arrow ${activeDropdown === "banking" ? "rotate" : ""}`}
                ></span>
              </div>
              <ul className={activeDropdown === "banking" ? "show" : ""}>
                <li>
                  <Link to="/banking">Banking D/W</Link>
                </li>
                <li>
            ...
            <li
              className={`dropdown ${
                ["/banks", "/sms"].includes(location.pathname) ? "active" : ""
              }`}
            >
              <div
                className="mobile-title"
              ...
              >
                ...
                <span
                  className={`arrow ${activeDropdown === "bank" ? "rotate" : ""}`}
                ></span>
              </div>
            ...
            <li className="dropdown">
              ...
              >
                ...
                <span
                  className={`arrow ${activeDropdown === "other" ? "rotate" : ""}`}
                ></span>
              </div>
              <ul className={activeDropdown === "other" ? "show" : ""}>
                <li>
                  <Link to="/comming-soon">Sport Control</Link>
                </li>
                <li>
                  <Link to="/comming-soon">Casino Control</Link>
                </li>
                <li>
                  <Link to="/slider_lists">Banner Manager</Link>
                </li>
                <li>
                  <Link to="/comming-soon">Offer</Link>
                </li>
            ...
            <li className="dropdown">
              ...
              >
                ...
                <span
                  className={`arrow ${activeDropdown === "Sport Management" ? "rotate" : ""}`}
                ></span>
              </div>
              <ul
                className={activeDropdown === "Sport Management" ? "show" : ""}
              >
                <li>
                ...
                <li>
                  <a href="/view_match">Declare Fancy Results </a>
                </li>
                <li>
                  <a href="/declare_result">Declare Match Results </a>
                </li>
                <li>
                  <a href="/declare_result_horsegreyhund">
                    Declare Horse & Greyhound Results{" "}
                  </a>
                </li>
              </ul>
            </li>
