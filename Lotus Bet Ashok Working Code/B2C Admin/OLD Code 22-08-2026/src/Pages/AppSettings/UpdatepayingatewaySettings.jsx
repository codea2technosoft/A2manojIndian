      ...
      <div className="row">
        <div className="col-md-12">
          <table className="table table-bordered">
            <tbody>
              <tr>
                <th className="text-dark" style={{ width: "200px" }}>ID</th>
                <td>{viewData._id}</td>
              </tr>
              <tr>
              ...
              <tr>
                <th className="text-dark">Min Amount</th>
                <td>₹{viewData.min}</td>
              </tr>
              <tr>
                <th className="text-dark">Max Amount</th>
                <td>₹{viewData.max}</td>
              </tr>
              <tr>
              ...
              {viewData.type === "bank_details" && (
                <>
                  ...
                  <tr>
                    <th className="text-dark">IFSC Code</th>
                    <td>{viewData.ifsc_code || 'N/A'}</td>
                  </tr>
                  <tr>
                    <th className="text-dark">Bank Name</th>
              ...
              {viewData.type === "upi" && (
                <tr>
                  <th className="text-dark">UPI ID</th>
              ...
              {viewData.type === "qr_code" && (
                <>
                  <tr>
                    <th className="text-dark">QR Code Data</th>
                    <td>{viewData.qr_data || 'N/A'}</td>
                  </tr>
                  {viewData.image && (
                    <tr>
                      <th className="text-dark">QR Code Image</th>
                      <td>
                        <img
                          src={viewData.image}
                          alt="QR Code"
              ...
              <tr>
                <th className="text-dark">Updated At</th>
