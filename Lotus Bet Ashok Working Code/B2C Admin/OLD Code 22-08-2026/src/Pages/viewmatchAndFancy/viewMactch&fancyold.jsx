                  ...
                  <th align="left" className="market-name-th" valign="middle">
                    {/* <div className="d-flex justify-content-between align-items-center">
                     <p className="text_blink"> Bookmaker</p> 
                      ...
                      <div onClick={onMyBookClicktotel} className="btn btn-light">Ttl Book</div>
                    </div>  */}
                  </th>
...
function Cricket() {
  ...
  const handlePlaceBet = useCallback(() => {
    ...
    const betData = {
      ...
      sport_id: "4",
      team_id: selectedOdds.market?.id || selectedOdds.rowId ,
      team: teamName,
      market_name: marketName,
      fancy_id: selectedOdds.market?.SelectionId || selectedOdds.rowId,
    };
  ...
  const getfancylist = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        ...
        `https://cricketfancylive.shyammatka.co.in/get-fancy-list-lotus?id=${event_id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getBookmakerList = useCallback(async () => {
    // const eventId = localStorage.getItem("event_id") || event_id;
    // if (!eventId) {
    //   return;
    // }
// alert(event_id)
