...
import { getallmatchbetshistory } from "../../Server/api";
...
const AllStatementlist = () => {
  ...
  const fetchStatementData = async (page = currentPage) => {
    try {
      ...
      const res = await getallmatchbetshistory({
      ...
      <section>
        <div className="card">
          <div className="card-header flex-wrap-mobile d-flex justify-content-between align-items-md-center gap-2">
            <h3 className="card-title mb-0">All match history</h3>
                    ...
                    <tbody>
                      {statementData.map((item, index) => (
                        <tr key={item._id || index}>
                          ...
                          <td>
                            <span
                              className={`badge d-inline ${item.bet_type === "fancy" ? "bg-info" : "bg-secondary"}`}
                            >
                          ...
                          <td>
                            <span
                              className={`badge ${item.bet_on === "back" ? "bg-success" : "bg-danger"}`}
                            >
