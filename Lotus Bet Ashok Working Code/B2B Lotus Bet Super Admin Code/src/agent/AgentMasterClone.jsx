...
import { FaCogs, FaPlus, FaSearch, FaUnlockAlt } from "react-icons/fa";
                  ...
                  [...agentData]
                    ...
                    .map((row, index) => (
                      ...
                      <td className="text-center">{row.commSession}</td> */}
                        ...
                        >
                          {row.bet_block === 1 ? (
                            <FaUnlockAlt className="lock_button text-success" title="Bet Open" />
                          ) : (
                            <FaLock className="lock_button text-danger" title="Bet Locked" />
                          )}
                        </span>
                      </td> */}
          ...
          >
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  {/* <p>
                    Deposit Balance to : <strong>{selectedAgent.name}</strong>
                  </p> */}
                  {/* <p className="mb-3">
          ...
          >
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  {/* <p>
                    Withdraw Balance to : <strong>{selectedAgent.name}</strong>
                  </p>
                  <p className="mb-3">
                    Current Balance: <strong>{selectedAgent.chips}</strong>
                  </p> */}
