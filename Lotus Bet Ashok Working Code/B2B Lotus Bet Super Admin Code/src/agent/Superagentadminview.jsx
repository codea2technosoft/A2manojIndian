          ...
          <div className="basicdata">
            ...
            <div className="heading">
              ...
              <div style={gridStyle}>
                ...
                <InfoCard title="Partnership Match" value={`${superAgentData.match_comm}%`} />
                <InfoCard title="Partnership Football" value={`${superAgentData.football_comm}%`} />
                <InfoCard title="Partnership Tennis" value={`${superAgentData.tennis_comm}%`} />
                <InfoCard title="Partnership Horse Racing" value={`${superAgentData.horse_racing_comm}%`} />
                <InfoCard title="Partnership Greyhound Racing" value={`${superAgentData.greyhound_racing_comm}%`} />
                <InfoCard title="Partnership Politics" value={`${superAgentData.politics_comm}%`} />
                <InfoCard title="Partnership Casino" value={`${superAgentData.casino_comm}%`} />
                <InfoCard title="Partnership Session" value={`${superAgentData.session_comm}%`} />
              </div>
            </div>
          </div>
