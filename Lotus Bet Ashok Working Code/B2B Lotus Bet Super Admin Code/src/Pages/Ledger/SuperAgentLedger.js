...
//   const [popupTitle, setPopupTitle] = useState("Super Master Transaction");
...
//         <div className="card-header border-0 bg-primary-yellow d-flex justify-content-between align-items-center gap-2 flex-wrap">
...
//                                 <td>
//                                   <div
//                                     className="d-flex align-items-center hover_user"
//                                     onClick={() =>
//                                       navigate(
//                                         `/settlement/agent-ledger?superagent_id=${m.admin_id}`,
//                                       )
//                                     }
//                                   >
//                                     {/* <FaEye
...
//                                     onClick={() =>
//                                       navigate(
//                                         `/settlement/super-agent-ledger-settlement-report/${m.admin_id}`,
//                                       )
//                                     }
//                                     title="History"
//                                   >
...
//                     {selectedSection === "lena"
//                       ? `SETTLEMENT FOR ${selectedAgent?.username || "User"}`
//                       : `SETTLEMENT FOR ${selectedAgent?.username || "User"}`}
//                   </h5>
...
function SuperAgentLedger() {
  ...
  //   if (id.startsWith("SM")) return "M";
  //   if (id.startsWith("SA")) return "S";
