...
//                     <button
//                       className={`btn btn-primary btn-sm w-100 ${isButtonDisabled ? "disabled-button" : ""
//                         }`}
//                       type="button"
              ...
              <tbody>
                {loadingTable ? (
                  <tr>
                    <td colSpan="8" className="table_loader">
                      <div className="py-5 text-center">
                        {/* Bootstrap Spinner - No Loader component needed */}
                  ...
                  marketData.map((item, index) => (
                    <tr key={item._id}>
                      ...
                      <td>
                        {item.result === 1 ? "Declared" : "Pending"}
                      </td>
                      <td>
                        {item.lenadena_settle === 0 ? (
                          <button
