...
const feedback = async (rate) => {
  try {
    const res = await fetch(`https://sara777adminapi.sindoor7.com/chat-ticket-close`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
