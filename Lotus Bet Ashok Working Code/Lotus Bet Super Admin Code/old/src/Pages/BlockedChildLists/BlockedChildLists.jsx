    ...
    try {
      ...
      if (response.data.success) {
        ...
        const formattedData = data.data.map((agent) => ({
          ...
          master_admin_id: agent.master_admin_id || agent.super_agent_id || agent.super_admin_id || "-",
          match_share: agent.match_share || 0,
          admin_otp: agent.admin_otp || agent.otp || "N/A",
          role: agent.role || "N/A",
          active: agent.active || 0,
          parent_username: agent.parent_username || agent.super_agent_username || agent.super_username || "N/A",
                              ...
                              >
                                ...
                                {row.admin_id?.startsWith("SM") && (
                                  <button
                                    ...
                                    onClick={() => {
                                      const selectedAdminId = row.admin_id;
                                      navigate(`/CreateSuperAgent/${selectedAdminId}`);
                                      setOptionMenu(null);
                                    }}
                                  >
                                    📋 Master
                                ...
                                {row.admin_id?.startsWith("MA") && (
                                  <button
                                    ...
                                    onClick={() => {
                                      const selectedAdminId = row.admin_id;
                                      navigate(`/CreateAgentmyuser/${selectedAdminId}`);
                                      setOptionMenu(null);
                                    }}
                                  >
                                    👤 Client
