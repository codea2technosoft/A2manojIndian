      ...
      <div className="card-body">
        ...
        <div className="row mb-3 align-items-end">
          <div className="col-md-2">
            <label className="fw-bold" style={{ fontSize: '13px' }}>PAYMENT TYPE</label>
            <select
          ...
          <div className="col-md-2">
            <label className="fw-bold" style={{ fontSize: '13px' }}>From</label>
            <input
              type="date"
              className="form-control form-control-sm"
              value={fromDate}
          ...
          <div className="col-md-2">
            <label className="fw-bold" style={{ fontSize: '13px' }}>To</label>
            <input
              type="date"
              className="form-control form-control-sm"
              value={toDate}
            ...
            <table className="table table-bordered table-sm">
              <thead style={{ backgroundColor: '#f8f9fa' }}>
                <tr>
                  ...
                  <th style={{ textAlign: 'right', fontSize: '12px' }}>DR</th>
                  <th style={{ textAlign: 'right', fontSize: '12px' }}>CR</th>
                  <th style={{ textAlign: 'right', fontSize: '12px' }}>BALANCE</th>
                  <th style={{ fontSize: '12px' }}>PAYMENT TYPE</th>
                ...
                {historyData.length === 0 ? (
                  ...
                  historyData.map((item, index) => (
                    <tr key={item._id || index}>
                      <td style={{ fontSize: '12px' }}>{formatDate(item.created_at)}</td>
                      {/* <td>
                        <button
