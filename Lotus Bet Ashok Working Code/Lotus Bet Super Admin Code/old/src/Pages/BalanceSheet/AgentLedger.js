...
import { getChildList, addNewTransaction, getMyLedgerTxn } from "../../Server/api";
                    ...
                    <div key={m.id} className="ledger-row">
                      <div className="w-50 username-link">
                        <div>
                          <FaEye
                            ...
                            onClick={() =>
                              navigate(`/reports/user-ledger?master_id=${m.admin_id}`)
                            }
                          />
                        </div>
                      ...
                      <div className="w-25 text-end">
                        ...
                        <button
                          ...
                          onClick={() => navigate(`/reports/agent-settlement-report/${m.admin_id}`)}
