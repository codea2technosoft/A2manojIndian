...
const CreateSuperAgentAdmin = () => {
  ...
  try {
    ...
    const payload = {
      ...
      // Match Commissions
      match_comm: formData.agentCommissionType === "0" ? 0 : (formData.agentMatchComm || 0),
      football_comm: formData.agentCommissionType === "0" ? 0 : (formData.agentFootballComm || 0),
      tennis_comm: formData.agentCommissionType === "0" ? 0 : (formData.agentTennisComm || 0),
      horse_racing_comm: formData.agentCommissionType === "0" ? 0 : (formData.agentHorseRacingComm || 0),
      greyhound_racing_comm: formData.agentCommissionType === "0" ? 0 : (formData.agentGreyhoundRacingComm || 0),
      politics_comm: formData.agentCommissionType === "0" ? 0 : (formData.agentPoliticsComm || 0),
      casino_comm: formData.agentCommissionType === "0" ? 0 : (formData.agentCasinoComm || 0),
      session_comm: formData.agentCommissionType === "0" ? 0 : (formData.agentSessionComm || 0),
    ...
    <>
      ...
      <div className="card">
        <div className="card-header bgHeader bg-primary-yellow d-flex justify-content-between align-items-center">
          <h5 className="card-title mb-0"><IoCreateSharp className="fs-2"/> Create New Super Master</h5>
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                <label className="form-label d-flex align-items-center justify-content-between">
                 Full Name* <span className="text-danger"></span> <small _ngcontent-owm-c76="">[A-Z , a-z , 0-9 , @ ] Allowed</small>
                </label>
                <input
                  type="text"
