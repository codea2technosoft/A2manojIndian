...
///new common apis//
export const commonCoinDeposit = (data) => API.post("/common-coin-deposit", data);
export const commonCoinWithdraw = (data) => API.post("/common-coin-withdraw", data);
...
export const toggleUserStatus = (userId, status) => {
  return API.patch(`/api/backend/${userId}/toggle-status`, { is_blocked: status });
};
