...
const CreateSuperAgentAdmin = () => {
    ...
    const checkFormValidity = () => {
        ...
        if (formData.agentCommissionType === "1") {
            ...
            const agentGreyhoundRacingComm = parseFloat(formData.agentGreyhoundRacingComm);
            ...
            const myGreyhoundRacingComm = parseFloat(formData.myGreyhoundRacingComm) || 0;
    ...
    const handleChange = (e) => {
        ...
        if (name === "agentCommissionType") {
            ...
            if (value === "0") { // Match Commission
                ...
                // Clint Match Comm को खाली करें (editable रखने के लिए)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const payload = {
                ...
                football_comm: formData.agentCommissionType === "0" ? 0 : parseFloat(formData.agentFootballComm) || 0,

                tennis_comm: formData.agentCommissionType === "0" ? 0 : parseFloat(formData.agentTennisComm) || 0,

                horse_racing_comm: formData.agentCommissionType === "0" ? 0 : parseFloat(formData.agentHorseRacingComm) || 0,

                greyhound_racing_comm: formData.agentCommissionType === "0" ? 0 : parseFloat(formData.agentGreyhoundRacingComm) || 0,

                politics_comm: formData.agentCommissionType === "0" ? 0 : parseFloat(formData.agentPoliticsComm) || 0,

                casino_comm: formData.agentCommissionType === "0" ? 0 : parseFloat(formData.agentCasinoComm) || 0,
                                ...
                                <div className="col-md-6">
                                    <div className="row">
                                        ...
                                        <div className="col-md-6> mb-3">
                                            ...
                                            {errors.myMatchShare && (
                                                <div className="invalid-feedback d-block">{errors.myMatchShare}</div>
                                            )}
                                        </div>
