            ...
            const payload = {
                ...
                match_comm:
                    formData.agentCommissionType === "0"
                        ? 0
                        : formData.agentMatchComm,

                football_comm:
                    formData.agentCommissionType === "0"
                        ? 0
                        : formData.agentFootballComm,

                tennis_comm:
                    formData.agentCommissionType === "0"
                        ? 0
                        : formData.agentTennisComm,
                ...
                politics_comm:
                    formData.agentCommissionType === "0"
                        ? 0
                        : formData.agentPoliticsComm,

                casino_comm:
                    formData.agentCommissionType === "0"
                        ? 0
                        : formData.agentCasinoComm,

                session_comm:
                    formData.agentCommissionType === "0"
                        ? 0
                        : formData.agentSessionComm,

                matka_comm:
                    formData.agentCommissionType === "0"
                        ? 0
                        : formData.agentMatkaComm,
            };
                ...
                <div className="card-body">
                    ...
                    >
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                <label className="form-label"> Greyhound Racing Commission </label>
                                <input
                                    type="text"
