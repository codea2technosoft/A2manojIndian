...
const CreateSuperAgentAdmin = () => {
    ...
    return (
        ...
        <h5 className="card-title mb-0">Create Super Agent Admin</h5>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                ...
                                {validated && !formData.coins && (
                                    <div className="invalid-feedback">Please enter valid coins</div>
                                )}
                            ...
                            <div className="col-md-6 mb-3">
                                ...
                                {validated && !formData.agentMatchShare && (
                                    <div className="invalid-feedback">Please enter valid match share</div>
                                )}
                            </div>
