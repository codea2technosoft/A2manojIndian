...
import UserSetting from "./UserWiseSettings/user-setting";
...
const App = () => {
    ...
    <Router>
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedRoute element={ProfitLoss} path="reports/profit-loss" />
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute element={ChipSummary} path="reports/chip-summary" />
          }
        />
        ...
        <Route
          path="/casino-setting/:id"
          element={
            <ProtectedRoute element={CasinoSetting} path="/casino-setting/:id" />
          }
        />
 ...
 <Route
          ...
          element={
            <ProtectedRoute element={ICasinoSetting} path="/icasino-setting/:id" />
          }
        />
 
 <Route
          path="/sport-setting/:id"
          element={
            <ProtectedRoute element={SportSetting} path="/sport-setting/:id" />
          }
        />
