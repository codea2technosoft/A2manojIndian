...
const PendingBets = () => {
  ...
  const fetchPendingBets = async (page = currentPage) => {
    try {
      setLoading(true);
      // ✅ Sirf navigationPayload se admin_id lo
      const payload = {
        admin_id: navigationPayload.admin_id || adminId,
      ...
      if (response.data && response.data.status_code === 1) {
        ...
        const errorMsg = response.data?.message || "Failed to fetch pending bets";
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <div className="table-responsive">
            ...
            {/* ✅ Pagination - Always show if there is data */}
