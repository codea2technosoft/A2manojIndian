...
function UserSetting() {
  ...
  const sportOrder = ["Football", "Cricket", "Tennis", "Horse Racing", "Greyhound Racing", "Kabaddi", "Casino", "Politics"];
  ...
  const fetchUserSettings = async () => {
    try {
      ...
      if (response.data && response.data.success) {
        ...
        // ✅ Page reload pe first sport active karo
        const firstSport = Object.keys(settingsObj)[0];
        if (firstSport) {
    ...
    try {
      ...
      if (responseData.success) {
        ...
        await Swal.fire({
          icon: 'success',
          title: 'Success!',
          text: responseData.message || 'Settings updated successfully for Me & Downline',
          timer: 2000,
          showConfirmButton: false
        });
      } else {
        ...
        <div className="card-body">
          ...
          {marketNames.length > 0 ? (
            marketNames.map((marketName) => {
              ...
              return (
                <div key={marketName} className="border-bottom pb-3 mb-3">
                  <h5 className="fw-bold mb-3">{marketName.replace(/_/g, ' ')}</h5>
                  <div className="row">
                    <div className="col-md-4 mb-3">
                      ...
                      <input
                        ...
                        value={market.minBet || ""}
                        onChange={(e) => handleChange(marketName, "minBet", e.target.value)}
                    ...
                    <div className="col-md-4 mb-3">
                      ...
                      <input
                        ...
                        className="form-control"
                        value={market.maxBet || ""}
                        onChange={(e) => handleChange(marketName, "maxBet", e.target.value)}
                    ...
                    <div className="col-md-4 mb-3">
                      ...
                      <input
                        ...
                        onChange={(e) => handleChange(marketName, "maxProfit", e.target.value)}
                    ...
                    <div className="col-md-4 mb-3">
                      ...
                      <input
                        ...
                        onChange={(e) => handleChange(marketName, "maxMarketProfit", e.target.value)}
                    ...
                    <div className="col-md-4 mb-3">
                      ...
                      <input
                        ...
                        onChange={(e) => handleChange(marketName, "maxLiability", e.target.value)}
                    ...
                    <div className="col-md-4 mb-3">
                      ...
                      <input
                        ...
                        onChange={(e) => handleChange(marketName, "maxMarketLiability", e.target.value)}
                        placeholder="Enter max market liability"
                      />
                    </div>

                    <div className="col-md-4 mb-3">
                      <label className="fw-bold">Bet Delay</label>
                      <input
                        type="number"
                        className="form-control"
                        value={market.betDelay || ""}
                        onChange={(e) => handleChange(marketName, "betDelay", e.target.value)}
                        placeholder="Enter bet delay"
                      />
                    </div>

                    <div className="col-md-4 mb-3">
                      <label className="fw-bold">Commission In</label>
                      <input
                        type="number"
                        className="form-control"
                        value={market.commissionIn || ""}
                        onChange={(e) => handleChange(marketName, "commissionIn", e.target.value)}
                        placeholder="Enter commission in"
                      />
                    </div>

                    <div className="col-md-4 mb-3">
                      <label className="fw-bold">Commission Out</label>
                      <input
                        type="number"
                        className="form-control"
                        value={market.commissionOut || ""}
                        onChange={(e) => handleChange(marketName, "commissionOut", e.target.value)}
