...
import {
  getCasinoSettingValues,
  updateCasinoSettingValues,
} from "../Server/api";
    ...
    try {
      ...
      for (let key in settings) {
        if (!settings[key] || settings[key] === "") {
          await Swal.fire({
            ...
            text: `Please fill ${key.replace(/_/g, " ").toUpperCase()}`,
      ...
      if (responseData.success) {
        ...
        await Swal.fire({
          icon: 'success',
          title: 'Success!',
          text: responseData.message || 'Casino settings updated successfully!',
          timer: 2000,
