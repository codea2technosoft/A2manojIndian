    ...
    <Router>
      <Routes>
        ...
        />
          ...
          element={
            <ProtectedRoute element={UserSetting} path="/user-setting/:adminId" />
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute element={ProfitLossSummary} path="reports/profit-loss-summary-event/:eventId" />
          }
        />
          ...
          element={
            <ProtectedRoute element={ProfitLossDetail} path="reports/profit-loss-detail/:eventId/:eventId" />
          }
        />
         ...
         <Route
          ...
          element={
            <ProtectedRoute element={ProfitLossMarketSummary} path="reports/profit-loss-summary-market/:eventId" />
          }
        />
          ...
          element={
            <ProtectedRoute element={ProfitLossMarketUsersDetails} path="reports/profit-loss-summary-market-users-details/:eventId" />
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute element={ProfitLossBetHistory} path="/reports/profit-loss-bet-history/:marketId" />
          }
        />
