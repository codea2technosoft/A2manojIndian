...
export const getAllEvents = (sportId, seriesId, payload = {}) => {
  ...
  const url = `/all-Eventslist-Tabs?${queryParams.toString()}`;
...
export const getAllUsersList = (params = {}) =>
  API.get("/alluserslist", { params });
...
export const getSingleUserNote = (user_id) => API.post(`/user-note/${user_id}`);
...
export const deleteFancyBetOddwise = (payload) =>
  API.post("/delete-fancy-bet-oddsWaise", payload);
...
export const UpdateSettings = (formData) =>
  API.post("/update-admin-setting", formData);
export const getAllScanners = () => API.get("/scanner-lists");

export const viewScanner = (id) => API.get(`/scanners-view/${id}`);
...
export const importMarketGet = (sport_id, event_id) =>
  API.post("/market-teams-name?id=" + event_id);
...
export const getAllgetAllDepositList = (params = {}) =>
  API.get("/admin-deposit-list", { params });
export const getAlltwithdrawList = (params = {}) =>
  API.get("/admin-withdraw-list", { params });

export const getAllBets = (params) => API.get("/get-all-bets", { params });
export const getAllpending = (params) =>
  API.get("/get-pending-bets", { params });
...
export const getDepositById = (id) => API.get(`/deposit_request/${id}`);

export const updateDepositStatus = (id, data) =>
  API.put(`/deposit_request_change_status/${id}`, data);

//fancy managment
export const getAllFancyMatches = (params = {}) =>
  API.get("/fancy/allmetchists", { params });
...
export const deleteFancyBets = (payload) =>
...
// };
export const getFancyList = (payload) => API.post("/get-fancy", payload);
...
export const toggleSliderStatus = (id) =>
  API.patch(`/sliders-change-status/${id}/status`);

//subAdmin Route//

export const createSubAdmin = (data) => API.post("/sub-admin-create", data);
export const getAllSubAdmins = () => API.get("/sub-master-list");
...
export const getSingleSubAdmin = (id) => API.get(`/sub-admin/${id}`);
...
export const getAdminProfile = (data) => API.post("/get-data", data);

export const getAdminDetails = (data) =>
  API.post("/get-edit-admin-details", data);

// Update client details
export const updateClient = (data) => API.post("/update-new-client", data);

export const updateClientStatususer = (admin_id, role, active) =>
  API.post("/update-user-status", { admin_id, role, active });
...
export const getAgentList = (payload) => API.post("/get-user-list", payload);
...
export const coinsDeposit = (data) => API.post("/coins-deposit-master", data);

export const coinsWithdraw = (data) => API.post("/coins-withdraw-master", data);

///new common apis//
export const commonCoinDeposit = (data) =>
  API.post("/common-coin-deposit", data);
export const commonCoinWithdraw = (data) =>
  API.post("/common-coin-withdraw", data);

export const blockUnblockMasteruser = (admin_id, role, is_blocked) =>
  API.post("/block-unblock-agent-user", { admin_id, role, is_blocked });

export const blockMasterList = (payload) =>
  API.post("/blocked-child-list", payload);
...
export const getAccountStatement = (payload) => {
  return API.post("/get-account-statement", payload);
};

export const getBetHistoryDetails = (payload) => {
  return API.post("/bet-history-details", payload);
};
...
////market analysis apis 29-06-2026

export const getMarketAnalysis = (params) => {
  return API.get("/api/backend/market-analysis", { params });
};

export const getEventDetail = (eventId, params) => {
  return API.get(`/api/backend/events/${eventId}/detail`, { params });
};

export const setUserMarketSetting = (payload) => {
  return API.post("/api/backend/user_market_setting", payload);
};

export const getBetHistory = (userId, marketId, params) => {
  return API.get(`/api/backend/orders/${userId}/unsettled-orders/${marketId}`, {
    params,
  });
};

// export const getBlockedChildList = ( payload ) =>
//   API.post("blocked-child-list", payload);
...
export const toggleUserStatus = (userId, status) => {
  return API.patch(`/api/backend/${userId}/toggle-status`, {
    is_blocked: status,
  });
};

// ✅ यूजर बेट लॉक/अनलॉक
export const toggleUserBetLock = (userId, payload) => {
  return API.post(`/api/backend/${userId}/update-order-lock`, payload);
};

export const toggleUserBetBlockUnblock = (userId, payload) => {
  return API.post(`/bet-block-unblock`, payload);
};

export const toggleUserClientBetBlockUnblock = (userId, payload) => {
  return API.post(`/user-bet-block-unblock`, payload);
};

export const getTopClientAll = (payload) => {
  return API.post("/top-client", payload);
};
...
export const getSportSettingNames = (payload) => {
  return API.post("/getSportSetting", payload);
};
 
export const updateSportSettingStatus = (payload) => {
  return API.post("/updateSportSetting", payload);
};

export const getCasinoSettingValues = (payload) => {
  return API.post("/getCasinoSetting", payload);
};
 
export const updateCasinoSettingValues = (payload) => {
  return API.post("/updateCasinoSetting", payload);
};

export const getUserUmltipleMarketSetting = (payload) => {
  return API.post("/getUserMarketSetting", payload);
};
 
export const updateUserOnlyMeMarketSetting = (payload) => {
  return API.post("/updateUserMarketSetting", payload);
};
 
export const updateMeDownlineSettingValues = (payload) => {
  return API.post("/update-me-downline", payload);
};

export const getProfitLossPL = (payload) =>
  API.post("/get-profit-loss", payload);

// export const getProfitLossSummary = (payload) =>
//   API.post("/get-profit-loss-summary-event", payload);
// export const getProfitLossDetail = (payload) =>
//   API.post("/get-profit-loss-details", payload);

export const getProfitLossSummary = (payload) =>
  // API.post("/get-profit-loss-summary-event", payload);
  API.post("/profit-loss/by-level", payload);

  export const getProfitLossDetail = (payload) =>
  API.post("/profit-loss-detail-market", payload);
...
export const getEventBetsCompletedAll = (payload) => {
  return API.post("/get-event-bets-completed", payload);
};

export const getSeriesHorseRacingCountryNameAll = (params) => {
  return API.get("/series-horse-country-name", {
    params,
  });
};
 
export const getSeriesHorseRacingCountryMatchListAll = (params) => {
  return API.get("/series-horse-country-match-list", {
    params,
  });
};