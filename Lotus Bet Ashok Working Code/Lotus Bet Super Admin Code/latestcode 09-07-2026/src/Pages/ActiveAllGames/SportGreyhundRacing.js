    ...
    return (
      <div className="card">
        <div className="card-body text-center">
          <Loader />
          <p className="mt-2">Loading grey hund racing data...</p>
        </div>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="card">
        <div className="card-header bgHeader bg-primary-yellow d-flex justify-content-between align-items-center">
          <h3 className="card-title mb-0">Grey Hund Racing</h3>
...
onClick={() =>
  navigate(
    `/greyhund-race-detail/series_idd/${match.market_id}/event_id/${match.event_id}/sportId/${match.sport_id}`
  )
}
                          >
                            {dt.time}
...
export default SportGreyhundRacing;