    ...
    <div className="dashboard">
      ...
      {/* <div className="row mb-4">
        <div className="col-md-6">
          <div className="padding_15 bg-white d-flex justify-content-between align-items-center">
            <div className="icon_money">
              <MdMoney size={24} />
            </div>
            <div className="played_amount">
              <h3><MdAttachMoney /> 0</h3>
              <p>Today Played Amount</p>
            </div>
          </div>
        </div>
        <div className="col-md-6">
          <div className="padding_15 bg-white d-flex justify-content-between align-items-center">
            <div className="icon_money bg-green">
              <MdMoney size={24} />
            </div>
            <div className="played_amount">
              <h3><MdAttachMoney /> 0</h3>
              <p>Today Winning Amount</p>
            </div>
          </div>
        </div>
      </div> */}
