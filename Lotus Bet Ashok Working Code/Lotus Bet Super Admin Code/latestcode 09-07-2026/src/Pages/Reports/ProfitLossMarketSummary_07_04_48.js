...
const ProfitLossMarketSummary = () => {
  ...
  const fetchMarketData = async () => {
    try {
      ...
      // Build payload with event_id and type
      const payload = { 
        event_id: eventId,
        // type: type // Send type from previous page
        type: 'agent' // Send type from previous page
      };
      
      console.log("Sending payload to market summary:", payload);
  ...
  // Handle username click - Navigate to user details page
