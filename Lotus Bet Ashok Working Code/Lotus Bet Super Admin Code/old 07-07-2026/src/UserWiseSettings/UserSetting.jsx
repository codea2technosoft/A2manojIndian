...
function UserSetting() {
  ...
  const handleUpdateOnlyMe = async (marketName) => {
    try {
      ...
      if (response.data && response.data.success) {
        toast.success(`Settings updated successfully for ${marketName}`);
  ...
  const handleUpdateMeAndDownline = async (marketName) => {
    try {
      ...
      if (response.data && response.data.success) {
        toast.success(`Settings updated for ${marketName} and downline!`);
        await fetchUserSettings();
      } else {
        toast.error(response.data?.message || "Failed to update settings");
      }
