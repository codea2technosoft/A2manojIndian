...
useEffect(() => {
  ...
  const fetchInactiveUserData = useCallback(async (page = 1, search = searchTerm, pageLimit = limit) => {
    try {
      ...
      const response = await axios.post(
        `${API_URL}/get-agent-user-block-list`,
        {
          role: 5,
          page: page,
          limit: pageLimit,
  ...
  const handleActivateUser = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL}/block-unblock-agent-user`,  // Using the correct endpoint
        {
          admin_id: activatingUser.admin_id,
          role: "5",
  ...
  <small>
    {/* <strong className="text-light d-block mb-2">Details:</strong> */}

    <ul className="list-unstyled listpopup mb-0 text-light">
      <li className="mb-2">
      ...
      <li className="d-flex align-items-center gap-2">
        ...
        <Badge
          bg={activatingUser.is_blocked === 1 ? "danger" : "success"}
        >
          {activatingUser.is_blocked === 1 ? "Blocked" : "Active"}
        </Badge>
      </li>
        ...
        <Modal.Footer>
          ...
          <button className="refreshbutton submitall"
      ...
      <div className="card">
        <div className="card-header flex-wrap-mobile bg-color-black text-white d-flex justify-content-between flex-wrap-mobile align-items-center">
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              {/* <button className="backbutton" onClick={handleRefresh}
        ...
        <Card.Body>
          {loading ? (
            ...
            <div className="text-center py-5">
              ...
              {searchTerm && (
                <button
                  className="refreshbutton" onClick={handleClearSearch}
                >
                  <i className="bi bi-x-circle me-1"></i>
                  Clear Search
                </button>
