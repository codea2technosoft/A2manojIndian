  ...
  const fetchInactiveUserData = async (page = currentPage) => {
    try {
      ...
      const response = await axios.post(
        `${API_URL}/get-agent-user-inactive-list`,
        {
          role: 5,
          page: page,
          limit: limit,
    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL}/update-user-status`,
        {
          ...
          role: "5", // Assuming role is always 3 for these users
      ...
      if (response.data.success) {
        ...
        //   toast.info("All inactive users have been activated!");
        // }
  ...
  return (
    <>
      ...
      <Modal show={showActivateModal} onHide={closeActivateModal} centered>
        ...
        <Modal.Footer>
          <button className="backbutton" onClick={closeActivateModal} disabled={activationLoading}>
            Cancel
          </button>
          <button
      ...
      <div className="">
        <div className="card">
          <div className="card-header gap-2 flex-wrap bg-color-black text-white d-flex justify-content-between align-items-center">
                        ...
                        <div className="d-flex gap-1">
                          {getPageNumbers().map((page) => (
                            <div
                              ...
                              className={`paginationnumber     ${currentPage === page ? "primary" : "outline-primary"}`}
