...
const CreateSuperAgentAdmin = () => {
  ...
  useEffect(() => {
    if (
      ...
      (!formData.agentMatchComm || formData.agentMatchComm === "")
    ) {
      setFormData((prev) => ({
        ...prev,
    ...
    if (
      ...
      (!formData.agentSessionComm || formData.agentSessionComm === "")
    ) {
      setFormData((prev) => ({
        ...prev,
          ...
          >
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                ...
                />
                <small className="text-muted">
                  Your maximum session commission
                </small>
              </div>
              ...
              <div className="col-12 text-center mt-4">
                ...
                {!isFormValid && (
                  <div className="text-danger mt-2">
                    <small>
                      Please fill all required fields (*) correctly to enable
                      submit button
                    </small>
                  </div>
                )}
