  ...
  return (
    <>
      <div style={{ padding: "20px" }}>
        ...
        <div className="buttondesing d-flex">
          <input
            value={message}
          ...
          <div className="popup-box text-center">
            ...
            <div className="imageflex">
              <div className="imageall">
                <img src={`${process.env.PUBLIC_URL}/assets/images/emoji1.png`} alt="emoji1" />
              </div>
              <div className="imageall">
                <img src={`${process.env.PUBLIC_URL}/assets/images/emoji5.png`} alt="emoji1" />
              </div>
              <div className="imageall">
                <img src={`${process.env.PUBLIC_URL}/assets/images/emoji4.png`} alt="emoji1" />
              </div>
              <div className="imageall">
                <img src={`${process.env.PUBLIC_URL}/assets/images/emoji3.png`} alt="emoji1" />
              </div>
              <div className="imageall">
                <img src={`${process.env.PUBLIC_URL}/assets/images/emoji2.png`} alt="emoji1" />
              </div>
            </div>
          </div>
        </div>
