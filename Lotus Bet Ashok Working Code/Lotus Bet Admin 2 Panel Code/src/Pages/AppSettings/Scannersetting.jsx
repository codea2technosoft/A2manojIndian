   ...
   <div className="container-fluid">
     <div className="card">
        <div className="card-header bg-color-black text-white d-flex justify-content-between align-items-center">
          <h3 className="card-title text-white mb-0">Scanner Setting</h3>
              ...
              <tr key={item._id}>
                ...
                <td>
                 <div className="actions">
                  ...
                  <button className="actionbutton delete" onClick={() => handleDelete(item._id)}>
                    Delete
                  </button>
                 </div>
                </td>
        ...
        <div className="modal d-block" style={{ background: "#00000080" }}>
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button className="refreshbutton" onClick={handleSubmit}>Save</button>
                <button className="refreshbutton" onClick={() => setModalOpen(false)}>Cancel</button>
              </div>
            </div>
          </div>
        </div>
