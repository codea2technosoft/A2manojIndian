      ...
      <div className="card">
        <div className="card-header bg-color-black">
          <div className="d-flex align-items-center justify-content-between">
            <h3 className="card-title text-white">Deposit List</h3>
              ...
              <div className="col-md-12">
                <div className="form-design-fillter gap-2 d-flex justify-content-between align-items-end flex-wrap">
                  ...
                  <div className="d-flex gap-2 mt-2">
                    <button className="btn btn-info text-white" onClick={handleFilter}>
                      Apply Filter
                    </button>
                    ...
                    {data.length > 0 ? (
                      data.map((item, index) => (
                        <tr key={item._id}>
                          ...
                          <td>{item?.userId?.mobile || "N/A"}</td>
                            <td>₹ {item.amount}</td>
                                 <td>
                            {item?.screenshot ? (
                              <img
                                src={`${process.env.REACT_APP_Image_URL}${item.screenshot.replace(/\\/g, "/")}`}
                                alt="deposit slip"
