...
function AgentMasterTransction() {
    ...
    const handleAutoSelectClient = async (adminId) => {
        try {
            setLoading(true);
            const response = await getChildListTransaction(4, admin_id);
            ...
            if (response.data && response.data.success) {
                ...
                const processedClients = clientData.map(user => {
                    ...
                    return {
                        ...
                        super_agent_username: user.super_agent_username
                    };
                });
        ...
        return (
            <div className="card mt-4">
                <div className="card-header bg-color-black">
                    <h3 className="card-title text-white mb-0">Agent Details</h3>
                </div>
...
<td>
 {
  transaction?.post_date
    ...
    : "No Date"
                                                    ...
                                                    <td>
                                                        {transaction.pay_type}                                                    </td>                                                    <td>{transaction.remarks || "-"}</td>
                                                    <td>
