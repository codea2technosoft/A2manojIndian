                ...
                {agentData.length > 0 ? (
                  agentData.map((row, index) => (
                    <tr key={row.id}>
                      ...
                      <td className="text-center">{row.super_agent_id}<br></br>{row.parent_username}</td>
      ...
      {dropdownOpen && currentRowData && (
        ...
        >
          ...
          <div
            className="dropdown-item custum_new_ul"
            onClick={() => {
              handleAccountoperationsuper(currentRowData);
              setDropdownOpen(null);
              setCurrentRowData(null);
              setDropdownPosition({ top: 0, left: 0, rowId: null });
            }}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <p className="mb-3">
                  parent
                  Balance: <strong>₹{selectedAgent.parent_coins}</strong>
                </p>
                <p className="mb-3">
