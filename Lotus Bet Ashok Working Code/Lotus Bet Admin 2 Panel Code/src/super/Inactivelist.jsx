    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL}/update-client-status`,
        {
          ...
          role: "4", // Assuming role is always 3 for these users
  ...
  return (
    <>
     ...
     <div className="card mt-4">
        <div className="card-header bg-color-black text-white d-flex justify-content-between align-items-center gap-2 flex-wrap">
                      ...
                      {inactiveUsers.map((user, index) => {
                        ...
                        return (
                          <tr key={user._id || index}>
                            ...
                            <td>
                              <span className={`${user.active === 0 ? 'inactivebadge' : 'activebadge'}`}>
