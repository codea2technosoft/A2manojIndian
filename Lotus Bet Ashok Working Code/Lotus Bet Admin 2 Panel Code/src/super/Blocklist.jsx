            ...
            <div className="text-center">
              ...
              {/* <div className="alert alert-info">
                <small>
                  ...
                  Status: <div className={activatingUser.is_blocked === 1 ? "inactivebadge" : "activebadge"}>
                    {activatingUser.is_blocked === 1 ? "Blocked" : "Active"}
                  </div>
                </small>
              </div> */}
              <div className="alert alert-dark p-3">
                <ul className="list-unstyled listpopup mb-0 text-light small">
                  <li className="mb-2">
