    ...
    <div className="mt-3">
      <div className="row gy-2">
        <div className="col-md-6">
          <div className="card">
            <div className="card-header bg-dark text-white">Create King Star Line Market</div>
                      ...
                      {mainMarkets.length > 0 ? (
                        mainMarkets.map((mkt, i) => (
                          <tr key={mkt._id}>
                            ...
                            {/* <td>{formatTo12Hour(mkt.open_time)}</td>
        <td>{formatTo12Hour(mkt.close_time)}</td> */}
                            <td>
                              <button
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">
                  {modalMode === "edit" ? "Update King Start Line Market" : "View King Start Line  Market"}
                </h5>
