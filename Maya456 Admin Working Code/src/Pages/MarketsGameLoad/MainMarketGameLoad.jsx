    ...
    <div className="card mt-3">
      ...
      <div className="card-header bg-color-black">
        <div className="d-flex align-items-center justify-content-between">
          <h3 className="card-title text-white">Main Market Game Load</h3>
      ...
      <div className="card-body">
        {fillter && (
          <div className="d-flex w-100 p-3 px-0 gap-2 align-items-center">
        ...
        <div className="box_number_deisgn">
          <div className="card">
            ...
            <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white">Jodi</div>
              </div>
            </div>
            <div className="card-body">
              <div className="box_flex">
            ...
            <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white">Half Sangam A</div>
              </div>
            </div>
            <div className="card-body">
              <div className="box_flex">
            ...
            <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white">Half Sangam B</div>
              </div>
            </div>
            <div className="card-body">
              <div className="box_flex">
            ...
            <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white">Full Sangam</div>
              </div>
            </div>
            <div className="card-body">
              <div className="box_flex">
