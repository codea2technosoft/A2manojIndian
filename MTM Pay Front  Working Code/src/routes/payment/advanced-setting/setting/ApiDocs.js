...
const ApiDocs = (props) => {
    ...
    const text = [
        <>
            <span>
                URL ={' '}
                <a href="https://api.mtmpay.in/api-login-merchant" target="blank">
    ...
    const text2 = [
        <>
            <span>
                URL ={' '}
                <a href="https://api.mtmpay.in/partner/payout" target="blank">
    ...
    const text3 = [
        <>
            <span>
                URL ={' '}
                <a href="https://api.mtmpay.in/webhook/payout/checkstatus" target="blank">
                    https://api.mtmpay.in/webhook/payout/checkstatus
                </a>
            </span>
            <p>Method = post</p>
        ...
        <div>
            <Card>
                <Row gutter={[16, 8]} align={'middle'}>
                    <Col xs={24} md={24}>
                        <Title level={5}>Developer / API Document</Title>
                    </Col>
                    <Col xs={24} md={24}>
