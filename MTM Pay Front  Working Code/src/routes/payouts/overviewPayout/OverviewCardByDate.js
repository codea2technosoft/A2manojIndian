                ...
                <Col xs={24} md={24} lg={15} xl={17}>
                    <Row gutter={[8, 8]} justify={{ md: 'center', lg: 'space-between' }} align={'middle'}>
                        ...
                        <Col xs={12} sm={6} md={6} lg={6} xl={6}>
                            <Card className="wallet_box custom_wallet">
                                {/* <Popover placement="bottom" title="Main Wallet" content={content} arrow={mergedArrow}> */}
                        ...
                        <Col xs={12} sm={6} md={6} lg={6} xl={6}>
                            <Card className="wallet_box custom_wallet">
                                {/* <Popover placement="bottom" title="Bonus Wallet" content={content} arrow={mergedArrow}> */}
                                    <div className="wallet_inner">
                                        <div className="wallet_icon">
                                            <img src={wallet} alt="wallet" />
                                        </div>
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box1 stats">
                            <div className="data">
                                ...
                                <p className="value">{data.Successtransaction || 0.00 }</p>
                            </div>
                            <div className="title">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box1 stats">
                            <div className="data">
                                ...
                                <p className="value">{data.FaildtransactionCount || 0.00}</p>
                            </div>
                            <div className="title">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box2 stats">
                            <div className="data">
                                ...
                                <p className="value">{parseFloat(data.SuccesstransactionAmount || 0.00).toFixed(2)}</p>
                            </div>
                            <div className="title">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box4 stats">
                            <div className="data">
                                ...
                                <p className="value">{data.InprocesstransactionAmount || 0.00}</p>
                            </div>
                            <div className="title">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box3 stats">
                            <div className="data">
                                ...
                                <p className="value">{parseFloat(data.Failedtransaction || 0.00).toFixed(2)}</p>
                            </div>
                            <div className="title">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box4 stats">
                            <div className="data">
                                ...
                                <p className="value">{parseFloat(data.TotalAmountTransactionCharge || 0.00).toFixed(2)}</p>
                            </div>
                            <div className="title">
                                <p className="name">Transaction Fees Amount</p>
                            </div>
                        </Card>
                    </Col>
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box1 stats">
                            <div className="data">
                                ...
                                <p className="value">{parseFloat(data.TotalAmountGst || 0.00 ).toFixed(2)}</p>
                            </div>
                            <div className="title">
                                <p className="name">GST Transaction Amount</p>
                            </div>
                        </Card>
                    </Col>
                </Row>
