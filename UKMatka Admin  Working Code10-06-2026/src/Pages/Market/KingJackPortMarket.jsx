...
export default function KingJackPortMarket() {
  ...
  const saveEditedMarket = async () => {
    try {
      ...
      const bodyPayload = {
        ...
        open_time: payload.open_time || "NA",
        close_time: payload.close_time || "",
        open_result_time: payload.open_result_time || "NA",
    ...
    <div className="mt-3">
      <div className="row gy-2">
        <div className="col-md-6">
          <div className="card">
            <div className="card-header bg-dark text-white">Create King Jack Port Market Market</div>
                        ...
                        {mainMarkets.length > 0 ? (
                          mainMarkets.map((mkt, i) => (
                            <tr key={mkt._id}>
                              ...
                              <td>
                                <div className="d-flex actionbutton">
                                  <button
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">
                  {modalMode === "edit" ? "Update King Jack Port Market" : "View King Jack Port  Market"}
                </h5>
