            ...
            <form noValidate onSubmit={handleSubmit}>
              <div className="row">
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    type="text"
                    className={`form-control ${minDepositError ? "is-invalid" : ""
                      }`}
                    name="min_deposit"
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    type="text"
                    className={`form-control ${maxDepositError ? "is-invalid" : ""
                      }`}
                    name="max_deposit"
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    type="text"
                    className={`form-control ${minWithdrawError ? "is-invalid" : ""
                      }`}
                    name="min_withdraw"
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    type="text"
                    className={`form-control ${maxWithdrawError ? "is-invalid" : ""
                      }`}
                    name="max_withdraw"
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    type="text"
                    className={`form-control ${perDayWithdrawError ? "is-invalid" : ""
                      }`}
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <select
                    className={`form-select ${withdrawEnableDisableError ? "is-invalid" : ""
                      }`}
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    type="text"
                    className={`form-control ${RegistrationBonusError ? "is-invalid" : ""
                      }`}
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    type="text"
                    className={`form-control ${ApkVersionError ? "is-invalid" : ""
                      }`}
                    name="apk_version"
                ...
                {/* <div className="col-md-6 mb-3">
                  <label className="form-label d-block">Payin Payment Mode</label>
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      type="radio"
                      id="payinOnline"
                      name="payinPaymentMode"
                      value="online"
                      checked={settings.payinPaymentMode === "online"}
                      onChange={handleChange}
                    />
                    <label className="form-check-label" htmlFor="payinOnline">
                      Online
                    </label>
                  </div>
                  ...
                  <div className="form-check form-check-inline ms-3">
                    <input
                      ...
                      name="payinPaymentMode"
                      value="offline"
                      checked={settings.payinPaymentMode === "offline"}
                      onChange={handleChange}
                    />
                    <label className="form-check-label" htmlFor="payinOffline">
                      Offline
                    </label>
                  </div>
                </div> */}
                ...
                {/* <div className="col-md-6 mb-3">
                  ...
                  <div className="btn-group" role="group">
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <label className="btn btn-outline-success" htmlFor="payinOnline">
                      Online
                    </label>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <label className="btn btn-outline-danger" htmlFor="payinOffline">
                      Offline
                    </label>
                  </div>
                </div> */}
                ...
                <div className="col-md-6 mb-3">
                  <label className="form-label d-block mb-3 fw-bold" style={{ fontSize: '14px', color: '#2c3e66' }}>
                    Payin Payment Mode
                  </label>

                  <div className="d-flex gap-3">
                    {/* Online Radio - Green */}
                    <label className="flex-fill" style={{ cursor: 'pointer' }}>
                      <input
                        type="radio"
                        name="payinPaymentMode"
                        value="online"
                      ...
                      <div
                        style={{
                          ...
                          fontWeight: '600',
                          fontSize: '15px',
                          backgroundColor: settings.payinPaymentMode === "online" ? '#28a745' : '#f8f9fa',
                          color: settings.payinPaymentMode === "online" ? '#fff' : '#6c757d',
                          border: settings.payinPaymentMode === "online" ? '2px solid #28a745' : '2px solid #dee2e6',
                          transition: 'all 0.2s ease',
                          boxShadow: settings.payinPaymentMode === "online" ? '0 4px 12px rgba(40,167,69,0.3)' : 'none'
                        }}
                      >
                        🌐 Online
                      </div>
                    ...
                    <label className="flex-fill" style={{ cursor: 'pointer' }}>
                      ...
                      <div
                        style={{
                          ...
                          fontWeight: '600',
                          fontSize: '15px',
                          backgroundColor: settings.payinPaymentMode === "offline" ? '#dc3545' : '#f8f9fa',
                          color: settings.payinPaymentMode === "offline" ? '#fff' : '#6c757d',
                          border: settings.payinPaymentMode === "offline" ? '2px solid #dc3545' : '2px solid #dee2e6',
                          transition: 'all 0.2s ease',
                          boxShadow: settings.payinPaymentMode === "offline" ? '0 4px 12px rgba(220,53,69,0.3)' : 'none'
                        }}
                      >
                        📱 Offline
                      </div>
