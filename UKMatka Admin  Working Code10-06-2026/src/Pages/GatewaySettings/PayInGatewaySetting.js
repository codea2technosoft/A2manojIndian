...
const PayInSetting = () => {
  ...
  const fetchSettings = async () => {
    try {
      ...
      //console.warn(result.data[0].image);
      if (result.success) {
  ...
  const handleSubmit = async () => {
    ...
    if (form.type === "qr_code" || form.type === "upi") {
...
/>
                        ...
                        <div>
                          ...
                          <span className="d-block">
                            <b>Bank Name</b>&nbsp;:&nbsp;{ucwords(item.bank_name)}
                          </span>
                          <span className="d-block">
                    ...
                    <>
                      ...
                      {isEditMode && form.image && (
                        <div className="mb-2 mt-2">
                          <img
                            src={`${process.env.REACT_APP_ImageAdmin_URL}/${form.image}`}
                            alt="QR"
                            style={{
                              width: 50,
                              height: 50,
