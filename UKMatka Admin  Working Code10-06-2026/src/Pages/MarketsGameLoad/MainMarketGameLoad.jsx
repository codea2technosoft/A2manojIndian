...
const MainMarketGameLoad = () => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.REACT_APP_API_URL}/market-list-gameload`,
        {
          ...
          body: JSON.stringify({ market_type: "mainmarket" }),
        },
      );
  ...
  const handleSearch = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const res = await fetch(
        `${process.env.REACT_APP_API_URL}/main-market-gameLoad`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    <div className="card mt-3">
      ...
      <div className="card-header bg-color-black">
        <div className="d-flex align-items-center justify-content-between">
          <h3 className="card-title text-white mb-0">Main Market Game Load</h3>
      ...
      <div className="card-body">
        {fillter && (
          <div className="d-flex w-100 pb-3 px-0 gap-2 align-items-center">
        ...
        <div className="box_number_deisgn">
          <div className="card">
            <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white mb-0">Digit</div>
              </div>
            </div>
            <div className="card-body">
          ...
          <div className="card mt-2">
            <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white mb-0">Jodi</div>
              </div>
            </div>
            <div className="card-body">
              <div className="box_flex">
                {Array.isArray(JodiGameLoad) && JodiGameLoad.length > 0 ? (
                  JodiGameLoad.map((item, index) => (
                    <div key={index} className="box_design">
                      <div
                        className={` ${
                          item.amount > 0 ? "green_border" : "box_number"
          ...
          <div className="card mt-2">
            <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white mb-0">Pana</div>
              </div>
            </div>
            <div className="card-body">
              <div className="box_flex">
          ...
          <div className="card mt-2">
            <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white mb-0">Half Sangam</div>
              </div>
            </div>
            <div className="card-body">
              <div className="box_flex">
                {Array.isArray(finalResultHalfSangamAGameLoad) &&
                finalResultHalfSangamAGameLoad.length > 0 ? (
                  finalResultHalfSangamAGameLoad.map((item, index) => (
                    <div key={index} className="box_design">
                      <div
                        className={` ${
                          item.amount > 0 ? "green_border" : "box_number"
          ...
          {/* <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white mb-0">Half Sangam B</div>
              </div>
            </div>
            <div className="card-body">
              <div className="box_flex">
                {Array.isArray(finalResultHalfSangamBGameLoad) &&
                finalResultHalfSangamBGameLoad.length > 0 ? (
                  finalResultHalfSangamBGameLoad.map((item, index) => (
                    <div key={index} className="box_design">
                      <div
                        className={` ${
                          item.amount > 0 ? "green_border" : "box_number"
          ...
          <div className="card mt-2">
            <div className="card-header header_design">
              <div className="d-flex justify-content-between align-items-center">
                <div className="card-title text-white mb-0">Full Sangam</div>
              </div>
            </div>
            <div className="card-body">
              <div className="box_flex">
                {Array.isArray(finalResultFullSangamGameLoad) &&
                finalResultFullSangamGameLoad.length > 0 ? (
                  finalResultFullSangamGameLoad.map((item, index) => (
                    <div key={index} className="box_design">
                      <div
                        className={` ${
                          item.amount > 0 ? "green_border" : "box_number"
