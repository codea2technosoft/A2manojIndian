...
function CreatedRolesList() {
  ...
  const fetchUsers = async (UserType) => {
    ...
    try {
      ...
      if (UserType === "tech_admin") {
        apiUrl = `${process.env.REACT_APP_API_URL}/admin-list`;
        roleToFilter = "admin";
      } else if (UserType === "admin") {
        apiUrl = `${process.env.REACT_APP_API_URL}/sub-admin-list`;
  ...
  const [data, setData] = useState([
    ...
    },
    {
      ...
      indeterminate: false,
      children: [
        { id: "main_market_list", name: "Main Market Lists", checked: false },
        // {
...

    {
      ...
      children: [
        {
          id: "declare_main",
          name: "Declare Main Market Result",
          checked: false,
        },
        // {
