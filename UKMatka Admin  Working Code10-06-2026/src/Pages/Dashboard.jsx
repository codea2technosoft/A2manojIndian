        ...
        {hasPermission("users_today") && (
          <>
            <div className="col-lg-3 col-md-4 col-6">
              <div
                onClick={() =>
                  handleBoxClick("/all_users", { todayuser: "yes" })
                }
                className="padding_15 bg-white d-flex align-items-center  position-relative"
            ...
            <div className="col-lg-3 col-md-4 col-6">
              <div
                onClick={() =>
                  handleBoxClick("/all_users", { yestardayuser: "yes" })
                }
                className="padding_15 bg-white d-flex align-items-center  position-relative"
                style={{ cursor: "pointer" }}
              >
        ...
        {hasPermission("all_users") && (
          <>
            ...
            <div className="col-lg-3 col-md-4 col-6">
              <div
                onClick={() =>
                  handleBoxClick("/all_users", { zerobalance: "yes" })
                }
                className="padding_15 bg-white d-flex align-items-center  position-relative"
                style={{ cursor: "pointer" }}
              >
      ...
      <div className="row">
        ...
        {hasPermission("deposite_pending") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() =>
                handleBoxClick("/deposite_pending", {
                  todaydeposit: "yes",
                  status: "pending",
                })
              }
        ...
        {hasPermission("deposite_complete") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() =>
                handleBoxClick("/deposite_complete", {
                  todaydeposit: "yes",
                  status: "success",
                })
              }
        ...
        {hasPermission("deposite_reject") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() =>
                handleBoxClick("/deposite_reject", {
                  todaydeposit: "yes",
                  status: "reject",
                })
              }
      ...
      <div className="row">
        ...
        {hasPermission("withdrawal_pending_Approve") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() =>
                handleBoxClick("/withdrawal_pending_Approve", {
                  todaywithdraw: "yes",
                  status: "pending",
                })
              }
        ...
        {hasPermission("withdrawal_complete") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() =>
                handleBoxClick("/withdrawal_complete", {
                  todaywithdraw: "yes",
                  status: "success",
                })
              }
        ...
        {hasPermission("withdrawal_reject") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() =>
                handleBoxClick("/withdrawal_reject", {
                  todaywithdraw: "yes",
                  status: "reject",
                })
              }
      ...
      <div className="row">
        ...
        {hasPermission("bet_history_pending") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() =>
                handleBoxClick("/bet_history_pending", {
                  todaybet: "yes",
                  status: "pending",
                })
              }
        ...
        {hasPermission("bet_history_success") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() =>
                handleBoxClick("/bet_history_success", {
                  todaybet: "yes",
                  status: "won",
                })
              }
        ...
        {hasPermission("game_load_bet_loss_lists") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() =>
                handleBoxClick("/game_load_bet_loss_lists", {
                  todaybet: "yes",
                  status: "lost",
                })
              }
