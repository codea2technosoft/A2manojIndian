  ...
  return (
    <div className="login-container overflow-hidden">
      <div className="d-flex justify-content-center align-items-center h-100 overflow-hidden">
        ...
        <div className="bg-white width_50 overflow-hidden d-flex align-items-center justify-content-center height_100vh">
          <div className="loginnew  px-24 max-w-464-px mx-auto">
            ...
            <form onSubmit={handleLogin} noValidate>
              ...
              <div className="my-3">
                <div className="form-group d-flex align-items-center mb-3 form-check">
                  <input
                    type="checkbox"
