...
export default function RefferReport() {
  ...
  const copyToClipboard = () => {
    navigator.clipboard
      .writeText("https://khelobeta.com?reffercode=" + refData.ref_code)
      .then(() => {
        Swal.fire(
          "Copied!",
                ...
                <div className="col-md-6 offset-md-3 col-12">
                  ...
                  <div className="chatsupportdesign">
                    ...
                    <div className="referlinkdesign">
                      <p>
                        Referral Link: https://khelobeta.com/?reffercode=
                        {refData.ref_code}
                      </p>
                      <button
...
DOWNLOAD करे.....khelobeta ऐप क्योंकि इसमें मिलता है आपको सबसे जायदा रेट 10के 980 रुपए और सबसे FAST एंड SAFE PAYMENT
 https://khelobeta.com/?reffercode=${refData.ref_code}`}
                        >
                          ...
                          <div className="refercode_new w-100 d-flex justify-content-between align-items-center">
                            <div className=" d-flex w-100 justify-content-between align-items-center gap-2">
                              ...
                              <div className="whatsappicon">
                                <Link
                                  className="w-100"
                                  to={`whatsapp://send?text=अब आप REFERAL CODE से अपने दोस्तो को जोड़ के भी 10 परसेंट पैसा कमा सकते हैं मेरा रेफरल कोड  👇  ${refData.ref_code} है https://khelobeta.com/`}
                                >
                                  <img src={whatsapp} alt="whatsapp" />
                                </Link>
                              </div>
