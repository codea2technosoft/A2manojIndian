...
import attachfile from "../../assets/img/attachfile.png";
...
export default function Gameposting() {
  ...
  const sendMessageRecording = (recordurl1) => {
    ...
    try {
      ...
      // Define the API endpoint URL
      let url = `https://chat.khelobeta.com/chat-store-audio`;
  ...
  const sendMessage = () => {
    ...
    try {
      ...
      let url = `https://chat.khelobeta.com/chat-store`;
  ...
  /> */}
      ...
      <section className="chat mt-5" id="chat">
        ...
        <p className="px-2 lineadd">
          {/* पैसे ऐड करने में अगर आपको समस्या है तो अपनी समस्या को टाइप करके भेजिए
          या वॉइस रिकॉर्ड करके भेजिए। */}
          {/* कृपया केवल दिए गए अकाउंट में ही पेमेंट करें। यदि कोई व्यक्ति अपनी तरफ
          से किसी पुराने अकाउंट में पेमेंट करता है, तो उसका पेमेंट Add नहीं होगा
          और इसके लिए वह स्वयं जिम्मेदार होगा। कृपया 200 रुपये से कम जमा न करें। */}
        </p>
        ...
        <div className="container-fluid">
          ...
          <div className="d-flex chatdesign">
            <div className="inputchat">
              <textarea
                style={{ height: "30px" }}
                className="form-control messagewidth"
            ...
            <div className="buttonsend">
              ...
              <label htmlFor="multipleFileInput" className="d-flex">
                <div className="fileattchdesign">
                  <img src={attachfile} />
                </div>
