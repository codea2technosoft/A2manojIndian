...
function Login() {
      ...
      .then((response) => {
        if (response.data.success == 1) {
          ...
          MySwal.fire({
            ...
            // navigate("/Home");
            window.location.href = `https://khelobeta.com/api/deposit.php?name=${response.data.name}&userid=${response.data.user_id}&amount=${amount}&contact=${mobilenew}&getaway=razorpay&type=web`;
          });
        } else {
          setLoading1(false);
          const MySwal = withReactContent(Swal);
  ...
  return (
    ...
    //               "https://khelobeta.com/web_video/iphone.mp4";
    //           }}
    //         >
    ...
    //           onClick={() => {
    //             window.location.href =
    //               "https://khelobeta.com/web_video/android.mp4";
    //           }}
    //         >
    //           <span className="text-danger">
    ...
    //                 target="_blank"
    //                 href="https://payment.khelobeta.com/khelobeta.apk"
    //                 download
    //               >
