...
const HomePage = ({ user, onChatStart }) => {
  ...
  }, [tickets]); // ✅ Removed CHECK_INTERVAL_MS from dependencies
  ...
  const checkForInactiveTickets = useCallback(() => {
    // ✅ PREVENT MULTIPLE SIMULTANEOUS CHECKS
    if (checkingTimeout || tickets.length === 0 || isProcessingRef.current || !isMountedRef.current) return;
    ...
    setCheckingTimeout(false);
    isProcessingRef.current = false;
  }, [tickets, checkingTimeout, showCloseTicketPopup, INACTIVITY_THRESHOLD_MS, INACTIVITY_THRESHOLD_MINUTES]);
  ...
  return (
    <div className="home-page">
      <div className="home-container">
        ...
        {/* Support Options */}
        <div className="card  card_chat_new">
          <div className='card-header'>
            <div className='card-title'> <h2>Choose Support Type</h2></div>
          </div>
