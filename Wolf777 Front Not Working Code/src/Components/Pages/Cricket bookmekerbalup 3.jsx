...
const BetSlipModalContent = memo(
  ({
    ...
    return (
      <div className="bet-slip-modal-content" onMouseEnter={fetchwallet_amount}   // 👈 hover par call
      >
                                ...
                                {[2, 1, 0].map((index) => (
                                  <div
                                    ...
                                    className={`back1 back-${index + 1
                                      } bettinggrid top ${index > 0 ? "boxhide" : ""
                                      }`}
                                    onClick={() =>
                                      handleOddsClick(
                                        market,
...
useEffect(() => {
 ...
 const callCountRef = useRef(0);
  ...
  useEffect(() => {
    const intervals = [];
    const intervalTime = showLoginModal ? 600000 : 200000;
                                    ...
                                    <td align="left" className="selaction_name" valign="middle">
                                      <div className="d-flex height_60 justify-content-between align-items-center">
                                        ...
                                        <span className="d-flex align-items-center gap-2">
                                          ...
                                          {/* <span className="ladderimage" role="button" >
                                            <img src={ladder} alt="ledder" />
                                          </span> */}
                                        </span>
                                      </div>
