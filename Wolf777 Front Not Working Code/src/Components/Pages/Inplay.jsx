        ...
        <div className="">
          ...
          <div className="tabs_inplay_content">
            {loading ? (
              ...
              <>
                <div className="cricketbettingalldesign new_design_we">
                  <div>
                    {filteredMatches.map((seriesItem, index) => {
                      ...
                      return (
                        <div
                          className="bet_tablearea exchange bgnewcolorgradient "
                          key={seriesItem._id || index}
                        >
                          <div className="team_name d-flex inplayhomepa">
                            <div  className="d-flex gap-md-2 align-items-md-center align-items-start flex-col-mobile"
                              onClick={() => {
