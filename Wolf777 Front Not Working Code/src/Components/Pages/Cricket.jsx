...
import Loader from "../../assets/images/loading-gif1.gif"
      ...
      <div className="modal-body">
        ...
        <div className="d-flex gap-2 justify-content-between mb-2">
          ...
          <div>
            <button
              type="button"
              className={`btn btn_custum_ho ${betType === 'back' ? 'successbutton' : 'btn-danger'}`}
...
const bookmakerMaxBet = localStorage.getItem("bookmaker_max_bet");
                  ...
                  <th align="left" className="market-name-th" valign="middle">
                    <div className="d-flex height_60 justify-content-between align-items-center">
                      ...
                      <p className="stack-info text_blink">
                        <span className="text_blink">Max:</span><span className="text_blink"> {bookmakerMaxBet}</span>
                      </p>
                    </div>
                  </th>
  ...
  const placeSessionBet = useCallback(
    async (betData) => {
      try {
        ...
        // console.warn("completeBetData 100", completeBetData)
  ...
  const placeRegularBet = useCallback(
    async (betData) => {
      try {
        ...
        console.warn("55555", completeBetData)
        const encryptedData = encryptData(completeBetData);
...
const fancyMaxBet = localStorage.getItem("fancy_max_bet");
                                      ...
                                      <td align="left" className="selaction_name" valign="middle">
                                        <div className="d-flex height_60 justify-content-between align-items-center">
                                          <span>
                                            ...
                                            {/* <small className="max_amt">min:{market.min || 100}</small> /
