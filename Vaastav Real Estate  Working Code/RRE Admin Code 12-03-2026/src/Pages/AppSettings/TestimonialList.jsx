    ...
    try {
      ...
      if (!showMessageModal) {
        showCustomMessageModal(
          "Error",
          err.message ||
            "An unexpected error occurred while fetching testimonials.",
          "error",
        );
      }
    } finally {
  ...
  const handleViewTestimonial = async (testimonialId) => {
    ...
    try {
      ...
      if (!response.ok) {
        const errorData = await response.json();
        throw new Error(
          errorData.message || "Failed to fetch testimonial details.",
        );
      }
      ...
      showCustomMessageModal(
        "Error",
        err.message ||
          "An unexpected error occurred while fetching testimonial details.",
        "error",
      );
    } finally {
      setLoading(false);
  ...
  const handleEditTestimonial = async (testimonialId) => {
    ...
    try {
      ...
      if (!response.ok) {
        const errorData = await response.json();
        throw new Error(
          errorData.message || "Failed to fetch testimonial for editing.",
        );
      }
      ...
      showCustomMessageModal(
        "Error",
        err.message ||
          "An unexpected error occurred while fetching testimonial for editing.",
        "error",
      );
    } finally {
      setLoading(false);
  ...
  const handleUpdateTestimonial = async (e) => {
    ...
    try {
      ...
      showCustomMessageModal(
        "Error",
        err.message ||
          "An unexpected error occurred while updating testimonial.",
        "error",
      );
    } finally {
      setLoading(false);
      ...
      async () => {
        ...
        try {
          ...
          if (!response.ok) {
            const errorData = await response.json();
            throw new Error(
              errorData.message || "Failed to delete testimonial.",
            );
          }
          ...
          showCustomMessageModal(
            "Error",
            err.message ||
              "An unexpected error occurred while deleting testimonial.",
            "error",
          );
        } finally {
          setLoading(false);
                        ...
                        {testimonial.vedioclips_reels ? (
                          <div className="video-preview-container">
                            ...
                            <div
                              ...
                              onClick={() =>
                                handlePlayVideo(
                                  `${imageAPIURL}/testimonial/${testimonial.vedioclips_reels}`,
                                )
                              }
                              style={{
                                width: "150px",
                          ...
                          >
                            <li className="dropdown-item">
                              <button
                                ...
                                onClick={() =>
                                  handleViewTestimonial(testimonial.id)
                                }
                  ...
                  <div className="card-body">
                    <div className="row">
                      ...
                      <div className="col-md-6 mb-3">
                        ...
                        <div className="form-control bg-light">
                          {selectedTestimonial.degination}
                        </div>
                      </div>
                    ...
                    {selectedTestimonial.vedioclips_reels ? (
                      <div className="mb-3">
                        ...
                        <div
                          ...
                          onClick={() =>
                            handlePlayVideo(
                              `${imageAPIURL}/testimonial/${selectedTestimonial.vedioclips_reels}`,
                            )
                          }
                          style={{
                            backgroundColor: "#000",
                      ...
                      <div className="mb-3">
                        ...
                        <div className="text-center p-4 border rounded bg-light">
                          ...
                          <p className="text-muted mb-0">
                            No video or reel available
                          </p>
                          <small className="text-muted">
                            Click Edit to add a video
                          </small>
                        </div>
                      </div>
                    )}
        ...
        <Modal.Body>
          <Form onSubmit={handleUpdateTestimonial}>
            ...
            <Form.Group className="mb-3" controlId="editTestimonialVideo">
              ...
              {editFormData.current_video_url && (
                <div className="mt-2">
                  ...
                  <div
                    ...
                    onClick={() =>
                      handlePlayVideo(
                        `${imageAPIURL}/testimonial/${editFormData.current_video_url}`,
                      )
                    }
                    style={{
                      backgroundColor: "#000",
                  ...
                  >
                    <div className="d-flex align-items-center justify-content-center gap-2">
                      ...
                      <span className="text-white">
                        {getVideoType(editFormData.current_video_url)}
                      </span>
                    </div>
                    <Button
              ...
              <Form.Text className="text-muted">
                Leave blank to keep current video. Max size: 100MB. Supported:
                MP4, MOV, AVI, WMV, FLV
              </Form.Text>
            </Form.Group>
              ...
              <div className="video-wrapper">
                <video
                  ...
                  onError={(e) => {
                    ...
                    showCustomMessageModal(
                      "Error",
                      "Failed to load video. Please check the file URL.",
                      "error",
                    );
                  }}
                >
