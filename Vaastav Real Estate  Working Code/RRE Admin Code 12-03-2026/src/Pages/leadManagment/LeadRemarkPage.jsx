    ...
    try {
      ...
      if (socket && socket.readyState === WebSocket.OPEN) {
        const notificationPayload = {
          user_id: userId,
          type: "loan_lead",
          message: `A response has been added for Property Lead Lead ${leadId}.`,
          statusremark: null,
          remark: response,
          order_id: orderId,
          action_by: "admin",
        ...
        <div className="card-header">
          <div className="d-flex align-items-center justify-content-between">
            <div className="titlepage">
              <h3>Remarks for Property Lead #{leadId}</h3>
            </div>
                ...
                <tbody>
                  {remarkList.map((remark, index) => (
                    <tr key={index}>
                      ...
                      <td><textarea style={{width:"100% ",height:"100px"}} className="form-control">{remark.lead_response}</textarea></td>
                    </tr>
                  ))}
                </tbody>
              </table>
