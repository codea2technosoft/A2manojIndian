  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        showCustomMessageModal("Error", errorData.message || "Failed to create Channel.", "error");
        return;
      }
      const result = await response.json();
      if (result.success == '1') {
        showCustomMessageModal("Success", result.message || "Channel has been created successfully", "success");
        setFormData({
          username: "",
          email: "",
          mobile: "",
