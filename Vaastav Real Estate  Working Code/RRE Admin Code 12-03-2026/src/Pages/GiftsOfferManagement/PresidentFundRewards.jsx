...
function PresidentFundRewards() {
  ...
  const fetchLedger = async (page = 1) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/president-rewards-lists?${params}`,
        {
          method: "GET",
  ...
  const handleDownloadFilteredExcel = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/download-president-fund-rewards-achievements-lists?${params}`,
        {
          method: "GET",
          headers: {
      ...
      Swal.fire({
        ...
        text: "Please Check Entered From Date & To Date For Downloading 40, 001 President Fund Royalty Achievements Report.",
      });
    }
  };
          ...
          <div className="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap-mobile">
            <div className="titlepage">
              <h3 style={{ whiteSpace: "wrap" }}>
                40, 001 President Fund Royalty Achievements Lists
              </h3>
            </div>
