...
/* =====================
   MAIN COMPONENT
===================== */
function LifeTimeRewardsWinnerListsDetails() {
    ...
    <div className="padding_15">
      <Card className="shadow-sm">
        <Card.Header className="d-flex justify-content-between align-items-center">
          <h4 className="mb-0">Senior Vice President Rewards Achievements – Breakdown</h4>
              ...
              {breakdown.self_and_remaining_detail && (
                <Card className="mb-4">
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center">
                      <Badge bg="success" className="me-1">
                        Achieved: {breakdownAchieved.self_and_remaining_area || "0.00"}
                      </Badge>
                      <Badge bg="warning" text="dark" className="me-1">
                    ...
                    <Table bordered hover className="mb-0">
                      ...
                      <tbody>
                        ...
                        {breakdown.self_and_remaining_detail.self && (
                          <UserRow
                            user={breakdown.self_and_remaining_detail.self}
                            level={1}
