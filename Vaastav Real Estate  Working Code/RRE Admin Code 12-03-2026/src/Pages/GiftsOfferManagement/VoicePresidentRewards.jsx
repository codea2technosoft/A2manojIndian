...
function VoicePresidentRewards() {
  ...
  const fetchLedger = async (page = 1) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/vice-president-rewards-lists?${params}`,
        {
          method: "GET",
  ...
  const handleDownloadFilteredExcel = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/download-team-voice-president-rewards-achievements-lists?${params}`,
        {
          method: "GET",
          headers: {
      ...
      Swal.fire({
        ...
        text: "Please Check Entered From Date & To Date For Downloading 10001 SQYD From Your Team Vice President Achievements Lists Report.",
      });
    }
  };
          ...
          <div className="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap-mobile">
            <div className="titlepage">
              <h3 style={{ whiteSpace: "wrap" }}>
                10001 SQYD From Your Team Vice President Royalty Achievements
                Lists
              </h3>
            </div>
...
export default VoicePresidentRewards;
