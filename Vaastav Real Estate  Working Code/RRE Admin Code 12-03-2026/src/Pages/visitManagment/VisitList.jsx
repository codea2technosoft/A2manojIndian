...
function VisitList() {
  ...
  const fetchVisits = async (page = 1, name = "", status = "", fromDate = "", toDate = "") => {
    // setLoading(true);
    const token = getAuthToken();
    try {
      const response = await axios.get(`${API_URL}/visite-list?page=${page}&limit=10&name=${name}&status=${status}&fromdate=${fromDate}&todate=${toDate}`, {
        headers: {
  ...
  if (error) {
    return <Container fluid><div className="alert alert-danger">{error}</div></Container>;
  }
        ...
        <div className="card-header d-flex justify-content-between align-items-center">
          ...
          {/* <div className="d-none d-md-block">
            <div className="d-flex gap-2">
              ...
              <div className="form-group" id="searchStatus">

                <Form.Group controlId="selectStatus">
                  <Form.Select value={searchStatus} onChange={handleSearchChangeLocation} className="text-light">
            ...
            <div className="d-flex gap-2 mb-3 mt-2 flex-wrap-mobile">
              ...
              <div className="form-group w-100" id="searchStatus">
                ...
                <Form.Group className="text-dark" controlId="selectStatus">
                  <Form.Select value={searchStatus} className="text-dark" onChange={handleSearchChangeLocation}>
                    <option value="">All</option>
                    <option value="start">Start</option>
                    <option value="end">End</option>
                  </Form.Select>
          ...
          <Table striped bordered hover responsive>
            ...
            <tbody>
              {visits.length > 0 ? (
                  ...
                  <tr key={visit.id}>
                    ...
                    <td>
                      {(() => {
                        ...
                        return Number.isFinite(m) ? (m / 1000).toFixed(2) + " km" : "—";
                      })()}
                    </td>

                    <td>
                      &#8377; {Number(visit.per_kilometer_amount).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                    </td>

                    <td>
                      &#8377; {Number(visit.amount).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                    </td>

                    <td style={{ color: visit.status === 'end' ? 'green' : visit.status === 'start' ? 'red' : 'inherit' }}>
                      {visit.status.toUpperCase()}
                    </td>
                    <td>
                      <Button variant="info" className="me-2" onClick={() => handleViewDetails(visit.id)}>
                        <FaEye />
                      </Button>
                ...
                <tr>
                  <td colSpan="8" className="text-center">No visits found.</td>
                </tr>
              )}
            </tbody>
          </Table>
              ...
              <div className="row">
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <div className="card h-100">
                    <div className="card-header bg-primary text-white">
                      <h6 className="mb-0">Visit By : [{selectedVisit.user_name}]</h6>
                    </div>
                    <div className="card-body">
                      <div className="mb-3">
                      ...
                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Visit Purpose</label>
                        <div className="fw-bold table-cell-remark">
                          {selectedVisit.visit_purpose
                            ? selectedVisit.visit_purpose.charAt(0).toUpperCase() + selectedVisit.visit_purpose.slice(1).toLowerCase()
                            : ''}
                      ...
                      <div className="mb-3">
                        ...
                        <div>
                          <span className={`badge fs-5 p-2 ${selectedVisit.status === 'end' ? 'bg-success' : 'bg-danger'}`}>
                      ...
                      <div className="mb-3">
                        ...
                        <div className="fw-bold">{selectedVisit.vehicle_type
                          ? selectedVisit.vehicle_type.charAt(0).toUpperCase() + selectedVisit.vehicle_type.slice(1).toLowerCase()
                          : ''}
                        </div>
                      </div>
                    </div>
                ...
                <div className="col-md-6 mb-3">
                  <div className="card h-100">
                    ...
                    <div className="card-body">
                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Visitor Name</label>
                        <div className="fw-bold">
                          {selectedVisit.name
                            ? selectedVisit.name.charAt(0).toUpperCase() + selectedVisit.name.slice(1).toLowerCase()
                            : ""}
                        </div>
                      ...
                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Visitor Mobile</label>
                      ...
                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Investment Budget</label>
                        <div className="fw-bold">
                          {selectedVisit.investment_budget !== undefined && selectedVisit.investment_budget !== null
                ...
                <div className="col-md-6 mb-3">
                  <div className="card h-100">
                    ...
                    <div className="card-body">
                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Per KM Amount (₹)</label>
                        <div className="fw-bold">₹{selectedVisit.per_kilometer_amount}</div>
                      </div>

                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Distance (Meter)</label>
                        <div className="fw-bold">{selectedVisit.distance}</div>
                      </div>

                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Duration (Minutes)</label>
                        <div className="fw-bold">
                          {Math.floor(selectedVisit.duration / 60)} min {selectedVisit.duration % 60} sec
                        </div>
                      </div>

                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Total Amount (₹)</label>
                        <div className="fw-bold h5 text-primary">₹{selectedVisit.amount}</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card h-100">
                    ...
                    <div className="card-body">
                      <div className="mb-3">
                        ...
                        <div className="fw-bold">
                          {new Date(selectedVisit.start_time).toLocaleString('en-US', {
                            year: 'numeric',
                            month: 'short',
                            day: 'numeric',
                            hour: '2-digit',
                      ...
                      <div className="mb-3">
                        ...
                        <div className="fw-bold">{selectedVisit.start_address}</div>
                      </div>

                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Visitor Image</label>
                      ...
                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Start Latitude</label>
                        <div className="fw-bold">{selectedVisit.start_lat}</div>
                      </div>


                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Start longitude</label>
                        <div className="fw-bold">{selectedVisit.start_long}</div>
                      </div>
                  ...
                  <div className="card h-100">
                    ...
                    <div className="card-body">
                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Date Time</label>
                        <div className="fw-bold">
                          {new Date(selectedVisit.end_time).toLocaleString('en-US', {
                            year: 'numeric',
                            month: 'short',
                            day: 'numeric',
                            hour: '2-digit',
                      ...
                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Address</label>
                        <div className="fw-bold">{selectedVisit.end_address}</div>
                      </div>

                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">Visit By Image</label>
                        <div style={{ position: 'relative' }}>
                          <img
                      ...
                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">End Latitude</label>
                        <div className="fw-bold">{selectedVisit.end_lat}</div>
                      </div>


                      <div className="mb-3">
                        <label className="form-label text-muted small mb-1">End longitude</label>
