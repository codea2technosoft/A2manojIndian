...
function AddExpenses() {
    ...
    // ✅ FIXED VALIDATION - Updated to include project/plot validation for commission categories
    const validateForm = () => {
        let newErrors = {};
        let isValid = true;
    ...
    // ✅ FIXED SUBMIT LOGIC - Updated to handle category type in payload
        ...
        try {
            ...
            const payload = {
                ...
                ...(formData.category_id === "1"
                    ? { parent_id: formData.parent_id, parent_name: parentName }
                    : { parent_id: "", parent_name: formData.name || "" }),
                                    ...
                                    <Row>
                                        ...
                                        <Col md={6}>
                                            <Form.Group className="mb-3">
                                                ...
                                                {/* <Form.Text className="text-muted">
                                                    Automatically set from selected payment account
                                                </Form.Text> */}
                                            </Form.Group>
                                        </Col>
                                        ...
                                        <Col md={6}>
                                            <Form.Group className="mb-3">
                                                ...
                                                />
                                                {/* <Form.Text className="text-muted">
                                                    This type will be sent in payload as 'type' field
                                                </Form.Text> */}
                                            </Form.Group>
                                        </Col>
