...
const IMAGE_API_URL = process.env.REACT_APP_Image_URL || "https://realestateapi.a2logicgroup.com/";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success == '1') {
        Swal.fire({
          title: 'Success!',
          text: formData.id ? 'Amenity updated successfully!' : 'Amenity created successfully!',
          icon: 'success',
    ...
    <div className="mt-2">
      <div className="card mb-4">
        <div className="card-header">
          {formData.id ? "Edit Amenity" : "Create New Amenity"}
        </div>
