...
/* =====================
   MAIN COMPONENT
===================== */
function PresidentFundRewardsRewardsDetails() {
    ...
    <div className="padding_15">
      <Card className="shadow-sm">
        <Card.Header className="d-flex justify-content-between align-items-center">
          <h4 className="mb-0">40,001 President Fund Rewards Achievements – Breakdown</h4>
          ...
          {/* <Card className="mb-4">
            <Card.Body className="text-center">
              <h4>
                ...
                >
                  {isEligible ? (
                    <>
                      <FaCheckCircle className="me-2" />
                      ELIGIBLE FOR PRESIDENT FUND REWARD
                    </>
                  ) : (
                    <>
                      <FaTimesCircle className="me-2" />
                      NOT ELIGIBLE FOR PRESIDENT FUND REWARD
                    </>
                  )}
                </Badge>
              </h4>
              <p className="text-muted mt-2">
                {isEligible 
                  ? "Congratulations! This user meets all criteria for the President Fund reward." 
                  : "This user does not meet the eligibility criteria for the President Fund reward."}
              </p>
            </Card.Body>
          </Card> */}
...
export default PresidentFundRewardsRewardsDetails;