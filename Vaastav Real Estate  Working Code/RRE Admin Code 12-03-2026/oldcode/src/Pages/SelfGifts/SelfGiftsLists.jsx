  ...
  const fetchData = async (page = 1, filterData = filters) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_URL}/gift-self-to-associate-list-given`,
        {
    ...
    <div className="card mt-2">
      <div className="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap-mobile">
        <div className="titlepage">
          <h3 className="mb-0">Self Gift To Associate</h3>
        </div>
      ...
      <div className="card-body">
        {isFilterActive && (
          <Form onSubmit={handleFilterSubmit} className="d-flex gap-2 mb-2 flex-wrap-mobile">
            <Form.Control
              type="text"
              name="mobile"
              className="w-100"
