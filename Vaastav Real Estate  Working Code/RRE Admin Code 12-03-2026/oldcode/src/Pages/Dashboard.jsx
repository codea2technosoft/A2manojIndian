    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const transformedData = [
          {
            title: "Today Associates",
            value: rawData.todayAssociate?.[0]?.total || 0,
            icon: "FaUserCircle",
            color: "primary",
            link: "/all-associate-list",
          },
          {
            title: "Today Channels",
            value: rawData.todayChannel?.[0]?.total || 0,
            icon: "FaUserCheck",
            color: "info",
            link: "/all-channel-list",
          },
...

          {
            ...
            value: rawData.AllAssociate?.[0]?.total || 0,
            icon: "FaUserCircle",
            color: "primary",
            link: "/all-associate-list",
          },
          {
            ...
            value: rawData.ActiveAssociate?.[0]?.total || 0,
            icon: "FaUserCheck",
            color: "success",
            link: "/all-associate-active-list",
          },
          {
            title: "Inactive Associates",
            value: rawData.InactiveAssociate?.[0]?.total || 0,
            icon: "RiCloseCircleLine",
            color: "danger",
            link: "/all-associate-inactive-list",
          },

          {
            title: "Total Channels",
            value: rawData.AllChannel?.[0]?.total || 0,
            icon: "FaUserCheck",
            color: "info",
            link: "/all-channel-list",
          },
          {
            ...
            value: rawData.ActiveChannel?.[0]?.total || 0,
            icon: "FaUserCheck",
            color: "success",
            link: "/all-channel-active-list",
          },
          {
            title: "Inactive Channels",
            value: rawData.InactiveChannel?.[0]?.total || 0,
            icon: "RiCloseCircleLine",
            color: "danger",
            link: "/all-channel-inactive-list",
          },
...

          {
            ...
            value: rawData.AllProject?.[0]?.total || 0,
          ...
          {
            title: "Total Plots",
            value: rawData.AllPlot?.[0]?.total || 0,
          ...
          },
          {
            ...
            value: rawData.ActivePlot?.[0]?.total || 0,
            icon: "PiListNumbersFill",
            color: "success",
            link: "/active-plot-list",
          },
          {
            title: "Sold Plots",
            value: rawData.InactivePlot?.[0]?.total || 0,
            icon: "RiCloseCircleLine",
            color: "danger",
            link: "/inactive-plot-list",
          },
          {
            title: "Total Property Lead",
            value: rawData.TotalPropertyLead?.[0]?.total || 0,
            icon: "GoProjectRoadmap",
            color: "primary",
          },
          {
            title: "Today Property Lead",
            value: rawData.TodayPropertyLead?.[0]?.total || 0,
            icon: "GoProjectRoadmap",
            color: "primary",
          },
          {
            title: "Total Loan Lead",
            value: rawData.TotalLoanLead?.[0]?.total || 0,
            icon: "PiListNumbersFill",
            color: "primary",
          },
          {
            title: "Today Loan Lead",
            value: rawData.TodayLoanLead?.[0]?.total || 0,
            icon: "PiListNumbersFill",
            color: "primary",
          },
        ];
        ...
        {showMessageModal && (
          ...
          >
            <div className="modal-dialog modal-dialog-centered">
              <div
                className={`modal-content ${messageModalContent.type === "success" ? "border-success" : messageModalContent.type === "error" ? "" : ""}`}
              >
                <div className="modal-header d-flex justify-content-between align-items-center">
                  <h5
                    className={`modal-title ${messageModalContent.type === "success" ? "text-success" : messageModalContent.type === "error" ? "text-danger" : "text-warning"}`}
                  >
