                    ...
                    {visits.map((visit, index) => (
                      <tr key={visit.id}>
                        ...
                        <td>
                          ...
                          {Math.floor(visit.duration / 60)} min {visit.duration % 60} sec
                        ...
                        <td>
                           <div>
                          {toSentenceCase(visit.visit_purpose)}
                            </div> 
                          </td>
                        <td>
                          <span
                            className={`badge ${visit.status?.toLowerCase() === "start"
                                ? "bg-danger"
