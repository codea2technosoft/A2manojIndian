...
function AllProjectList() {
  ...
  const fetchProjects = async (
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/project-list-all?page=${page}&limit=10&name=${searchTermName}&location=${location}&status=${status}`,
        {
          headers: {
  ...
  useEffect(() => {
    fetchProjects(currentPage, searchTerm, searchTermLocation, statusFilter);
  }, [currentPage, searchTerm, searchTermLocation, statusFilter]);
                ...
                return (
                  <Col col={4} xs={12} md={4} key={project.id}>
                    <Card className="property_design">
                      ...
                      <devicePixelRatio className="d-flex justify-content-between align-items-center">
                      ...
                      <Card.Body>
                        ...
                        <br />
                        <strong>Legality : </strong> {project.legality} <br />
                        <strong>Resident Commission : </strong> ₹
                        {project.resident_commission} Per Sq. Yard
                        <br />
                        <strong>Commercial Commission : </strong> ₹
                        {project.commercial_commission} Per Sq. Yard <br />
                        <strong>Corner Resident Commission : </strong> ₹
                        {project.corner_resident_commission} Per Sq. Yard
                        <br />
                        <strong>Corner Commercial Commission : </strong> ₹
                        {project.corner_commercial_commission} Per Sq. Yard
                        <br />
                        <strong>Project Size : </strong> {project.project_size}{" "}
                        Sq. Yard
                        <br />
                        <strong>Date & Timing : </strong> {project.date_time}
                        <br /> */}
                          ...
                          <div className="project-details-grid">
                            <div className="detailsproperty">
                              ...
                              <div className="project_details">
                                ...
                                <span> {project.businessVolume}</span>
                              </div>
                              <div className="project_details">
                                <span className="name_title">
                                  Approve Authortiy
                                </span>{" "}
                                <span> {project.legality}</span>
                              </div>
                              <div className="project_details">
                                <span className="name_title">
                                  Total Township Area
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-12">
                        <div className="custum_all">
                          ...
                          <textarea
                            className="form-control"
                            value={selectedProject.description.replace(
                              /<[^>]+>/g,
                              ""
                            )}
                            readOnly
                              ...
                              (item, idx) => (
                                <li key={idx} className="amenitiesbox">
                                  <div className="amenitiesboximage">
                                    <img
                                      src={`${aminitiesimagePath}${item.image}`}
                                      alt={item.name}
                                    />
                                  </div>
                                  <span>{item.name}</span>
