...
const fetchmyteamLinesSummaryAssociate = async () => {
  try {
    ...
    if (data.status === "1") {
      // Extract line data from response
      const newLineData = {
      ...
      // Dashboard state ko update karein
      setDashboard(prev => ({
        ...prev,
      ...
      // Line summary ko bhi update karein
      setLineSummary({
        first_line: newLineData.line1.total_members || 0,
        second_line: newLineData.line2.total_members || 0,
        third_line: newLineData.line3.total_members || 0
    ...
    // Error case mein default values set karein
    const defaultData = {
      line1: { total_buysqft: 0, total_members: 0, line_name: "Line 1" },
      line2: { total_buysqft: 0, total_members: 0, line_name: "Line 2" },
      line3: { self_buysqft: 0, total_members: 0, line_name: "Others" },
  ...
  // {
  //   title: "Total Lines Summary",
  //   value: (
  //     <span
  //       style={{
  //         color: lineData.summary.total_buysqft === 0 ? "red" : "green",
  //       }}
  //     >
  //       {Number(lineData.summary.total_buysqft).toFixed(2)} SQFT
  //     </span>
  //   ),
  //   icon: "CiLineHeight",
  //   href: "#",
  ...
  // Team Gift Progress Component - Same layout as Self Gift Progress
  const TeamProgressBar = () => {
    ...
    return (
      <div className="gift-progress-wrapper">
        ...
        {/* Progress Summary */}
        {/* <div className="gift-progress-summary mt-3">
          <Row className="text-center">
            <Col sm={4}>
              <div className="summary-item">
                <div className="summary-label">Current Progress</div>
                <div className="summary-value text-success">{currentTeamSqyd} SQYD</div>
              </div>
            </Col>
            <Col sm={4}>
              <div className="summary-item">
                ...
                <div className="summary-value text-warning">
                  {Math.max(0, maxTeamSqyd - currentTeamSqyd)} SQYD
                </div>
              </div>
            </Col>
            <Col sm={4}>
              <div className="summary-item">
                ...
                <div className="summary-value text-info">
                  {((currentTeamSqyd / maxTeamSqyd) * 100).toFixed(1)}%
                </div>
              </div>
            </Col>
          </Row>
    ...
    return (
      <div className="gift-progress-wrapper">
        ...
        {eligibilityData.length > 0 ? (
          ...
          <NoDataMessage message="Sorry, no eligibility date data found" />
        )}
      </div>
    );
  };
