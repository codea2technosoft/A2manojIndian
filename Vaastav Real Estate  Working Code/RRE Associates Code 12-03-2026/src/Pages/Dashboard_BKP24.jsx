...
const Dashboard = ({ userType }) => {
  ...
  const rawData = [
    {
      ...
      value: <span style={{ color: dashboard.totalAssociate === 0 ? "red" : "green" }}>
    ...
    },
    {
      ...
      value: <span style={{ color: dashboard.totalChannel === 0 ? "red" : "green" }}>
    ...
    },
    {
      ...
      value: <span style={{ color: dashboard.activeProject === 0 ? "red" : "green" }}>
    ...
    },
    {
      ...
      value: <span style={{ color: dashboard.ongoingProject === 0 ? "red" : "green" }}>
    ...
    },
    {
      ...
      value: <span style={{ color: dashboard.completeProject === 0 ? "red" : "green" }}>
    ...
    },
    {
      ...
      value: <span style={{ color: dashboard.totalTeamCount === 0 ? "red" : "green" }}>
    ...
    },
    {
      ...
      value: <span style={{ color: dashboard.total_property === 0 ? "red" : "green" }}>
    ...
    },
    {
      ...
      value: <span style={{ color: dashboard.total_lead_loan === 0 ? "red" : "green" }}>
  ...
  const dashboardData =
    userType === "channel"
      ? rawData.filter((item) => item.title !== "Total Direct Associates")
      : rawData;
