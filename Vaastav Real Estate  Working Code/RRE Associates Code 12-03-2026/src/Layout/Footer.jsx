          ...
          <div className="col-md-12">
            <div className="d-flex align-items-center flex-wrap-mobile justify-content-between footercopyright">
              <div className="text-center">
                <b>© 2025 Vaastav Real Estate Pvt Ltd. All rights reserved.</b>
              </div>
              <div className="d-flex socialmediadeign">
                ...
                <a
                  href={
                    siteSettings?.insta_link && siteSettings.insta_link.trim() !== ""
                      ? siteSettings.insta_link
                      : "https://www.instagram.com"
                  }
                  target="_blank"
                ...
                <a
                  href={
                    siteSettings?.teligram_link && siteSettings.teligram_link.trim() !== ""
                ...
                <a
                  href={
                    siteSettings?.youtube_link && siteSettings.youtube_link.trim() !== ""
                      ? siteSettings.youtube_link
                      : "https://www.youtube.com"
                  }
                  target="_blank"
                ...
                <a
                  href={
                    siteSettings?.office_location_link && siteSettings.office_location_link.trim() !== ""
                ...
                <a
                  href={
                    siteSettings?.zoom_meeting_link && siteSettings.zoom_meeting_link.trim() !== ""
