...
const PageTitle = ({ title }) => {
  ...
  const routeMap = {
    ...
    '/aboutus': 'About Us',
    '/download-vaastav-plans': 'Download Vaastav Plan',
    '/marketingpartmner_rule': 'Marketing Partner Rule'
  };

  // Helper function to clean unwanted chars
  const sanitizeText = (text) => text?.replace(/[%/\d]/g, " ") || " ";
  ...
  const currentPage = sanitizeText(
        ...
        <div className="breadcrumb-wrapper text-center">
          <div className="inline-flex flex-wrap justify-center items-center">
            {breadcrumbs.map((item, index) => {
              ...
              const cleanPath = sanitizeText(item.path);
