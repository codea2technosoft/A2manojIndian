        ...
        try {
            ...
            if (responseData.upload_rre_plans_pdf) {
                setPreviousList([
                    {
                        id: 1,
                        title: "Vaastav Real Estates Rules Book Details",
 ...
 <div className="d-none d-md-block">
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            <h3 class="main_headin-2 "> Download Vaastav Real Estates Plan Details</h3>
                    ...
                    <div className="card">
                        <div className="card-header d-flex justify-content-between align-items-center">
                            <div className="card-title"><strong>Vaastav Real Estates Plan Details</strong></div>
                            <div >
                                <a
