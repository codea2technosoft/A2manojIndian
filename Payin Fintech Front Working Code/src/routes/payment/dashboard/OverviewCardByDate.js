...
// request
import { getPayInOverviewSummary } from 'requests/statistic';
...
const OverviewCardByDate = (props) => {
    ...
    const getData = async (dates) => {
        ...
        try {
            ...
            const response = await getPayInOverviewSummary(filters);
                ...
                <Col xs={24} md={16} lg={9} xl={7}>
                    ...
                    <Card className="wallet_box">
                        <div className='d-flex gap-2 align-items-center'>
                              <div className='d-flex gap-2 align-items-center wallet_box_design'>
                                    <div className='walletimage'>
                                        <img src={wallet} alt="wallet"/>
                                    </div>
                                    <h3 className='mb-0'>Wallet
                                        <span className='d-block'>{data.payinWalletBalance}/-</span>
                                    </h3>
                              </div>
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box1 stats">
                            <div className="data">
                                ...
                                <p className="value">{data.failTransaction}</p>
                            </div>
                            <div className="title">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box4 stats">
                            <div className="data">
                                ...
                                <p className="value">{data.refundTransaction}</p>
                            </div>
                            <div className="title">
                                <p className="name">No of Refund Transaction</p>
                            </div>
                        </Card>
                    </Col>
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box2 stats">
                            <div className="data">
                                ...
                                <p className="value">{parseFloat(data.successAmount).toFixed(2)}</p>
                            </div>
                            <div className="title">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box3 stats">
                            <div className="data">
                                ...
                                <p className="value">{parseFloat(data.faildAmount).toFixed(2)}</p>
                            </div>
                            <div className="title">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8}>
                        <Card className="box4 stats">
                            <div className="data">
                                ...
                                <p className="value">{data.refundAmount}</p>
                            </div>
                            <div className="title">
                                <p className="name">Refund Amount</p>
                            </div>
                        </Card>
                    </Col>
                </Row>
