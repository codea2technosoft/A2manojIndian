  ...
  const fetchUsers = async (UserType) => {
    ...
    try {
      ...
      if (UserType === "tech_admin") {
        apiUrl = `${process.env.REACT_APP_API_URL}/admin-activelist`;
        roleToFilter = "admin";
      } else if (UserType === "admin") {
        apiUrl = `${process.env.REACT_APP_API_URL}/sub-admin-active-list`;
                              ...
                              <ul>
                                <div className="row">
                                  {getSelectedItems().map((item, index) => (
                                    <div className="col-md-6 textwhitenew">
                                      <p
                                        className="textwhitenew pb-0"
                                        key={index}
                                      >
                                        {item}
                                      </p>
