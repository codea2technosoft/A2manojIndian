...
function UsersList() {
  ...
  const handleSearchChange = (e) => {
    ...
    const filtered = users.filter((user) => {
      ...
      return userName.includes(value) || mobile.includes(value) || color.includes(value);
    });
                  ...
                  <tbody>
                    {currentUsers.length === 0 ? (
                      ...
                      currentUsers.map((user, index) => (
                        <tr key={user._id} >
                          <td><div className="d-flex align-items-center"> {indexOfFirstUser + index + 1} <span className="indicator" style={{ background: user.color || "transparent" }}></span></div> </td>
                          <td>
                          ...
                          <td>
                           ...
                           <div className="selectcolor">
                             <select
                              ...
                              value={user.color || ""}
                              onChange={(e) =>
                                handleColorChange(user.user_id, e.target.value)
                              }
                            >
