  ...
  const fetchReport = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_API_URL}withdraw-list-report`,
        {
          method: "POST",
          headers: {
      ...
      {loading ? (
        ...
        <>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <button
                          ...
                          onClick={() =>
                            navigate(`/withdrawal_datewise_details/${item._id}`)
                          }
                        >
                          View
                        </button>
          ...
          {data.length > 0 && totalPages > 0 && (
            <ul className="pl-0 d-flex justify-content-between align-items-center mt-3">
              <li
