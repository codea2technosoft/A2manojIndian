...
const MainMarketGameLoad = () => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.REACT_APP_API_URL}/market-list-gameload`,
        {
          ...
          body: JSON.stringify({ market_type: "kingjackport" }),
        }
      );
  ...
  const handleSearch = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const res = await fetch(
        `${process.env.REACT_APP_API_URL}/jackport-market-gameLoad`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      <div className="card">
        <div className="card-header bg-color-black">
          <div className="d-flex align-items-center justify-content-between">
            <h3 className="card-title text-white">King Jack Port Game Load</h3>
        ...
        <div className="card-body">
          {fillter && (
            <div className="d-flex gap-2 px-0 p-3 align-items-center">
