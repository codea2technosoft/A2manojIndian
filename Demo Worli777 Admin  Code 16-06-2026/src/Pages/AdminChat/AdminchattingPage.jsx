...
const UserChat = () => {
  ...
  useEffect(() => {
    const initializeSocket = () => {
      if (!socketRef.current) {
        const socket = io("https://chatapi.demowarlimatkaapi.shyammatka.co.in", {
  ...
  const chatUser = async () => {
    try {
      const res = await fetch(
        `https://adminapis.demowarlimatkaapi.shyammatka.co.in/chat-list`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const feedback = async (rate) => {
    try {
      const res = await fetch(
        `https://adminapis.demowarlimatkaapi.shyammatka.co.in/chat-ticket-close`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
