    ...
    <div className="dashboard mt-2">
      ...
      <div className="row">
        ...
        {/* {hasPermission("withdrawal_pending") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() => handleBoxClick("/withdrawal_pending", { todaywithdraw: "yes", status: "pending", showCount: "true" })}
              className="padding_15 bg-white d-flex gap-2 align-items-center  position-relative"
              style={{ cursor: "pointer" }}
            >
        ...
        {/* {hasPermission("withdrawal_pending") && (
          <div className="col-lg-3 col-md-4 col-6">
            <div
              onClick={() => handleBoxClick("/withdrawal_pending", { allwithdraw: "yes", status: "pending", showCount: "true" })}
              className="padding_15 bg-white d-flex gap-2 align-items-center  position-relative"
              style={{ cursor: "pointer" }}
            >
