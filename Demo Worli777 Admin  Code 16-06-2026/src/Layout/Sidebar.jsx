...
const Sidebar = ({ isOpen, onToggleSidebar, userType, permissions }) => {
  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              title: "Admin Deposit Date Wise Report",
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              title: "Admin Withdraw Date Wise Report",
        ...
        {
          id: "GameLoadManagement",
          title: "Game Load Markets",
          dropdown: true,
          icon: (
            <svg
              width="24"
          ...
          children: [
            {
              ...
              title: "Main Market Game Load",
              href: "/main_market_game_load",
            },
            // {
            //   id: "king_jackport_game_load",
            //   title: "King Jack Port Game Load",
            //   href: "/king_jackport_game_load",
            // },
            {
              id: "king_starline_game_load",
              title: "King Starline Game Load",
              href: "/king_starline_game_load",
            },
          ],
        },
        ...
        },
        {
...

         {
          ...
          children: [
            {
              id: "notice-board-management",
              title: "Notice Boards",
              href: "/notice-board-management",
            },
          ],
        },

        {
          ...
          children: [
            ...
            //  {
            //   id: "csv-upload",
            //   title: "Upload Bulk Result",
            //   href: "/upload-result-inCSV",
            // },
            ...
            //  {
            //   id: "upload-manul-results",
            //   title: "Upload Manual Results",
            //   href: "/upload-manul-results",
            // },
  ...
  const renderMenuItem = (item, level = 0) => {
    ...
    return (
      <li key={item.id} className={`menu-item ${item.className}  ${isActive ? "active" : ""}`}>
        <Link
