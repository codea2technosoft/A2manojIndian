  ...
  const fetchReport = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_API_URL}admin-deposit-datewise`,
        {
          method: "POST",
          headers: {
      ...
      <div className="card">
        <div className="card-header bg-color-black">
          <div className="d-flex align-items-center justify-content-between">
            <h3 className="card-title text-white">Admin Deposit Date List</h3>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        ...
                        <button
                          className="btn btn-sm btn-primary"
                          onClick={() =>
                            navigate(`/admin_deposit_detail/${item._id}`)
                          }
                        >
                          View
                        </button>
