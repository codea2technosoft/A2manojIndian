...
function UserBetsExposerDetails() {
  ...
  const fetchBets = async (page = pagination.page) => {
    ...
    setLoading(true);
    try {
      const response = await getUserExposure({
        user_id: userId,
        page: page,
    ...
    <>
      <div className="card">
        <div className="card-header bg-color-black p-2 text-white d-flex justify-content-between align-items-center">
          <h3 className="card-title mb-0">User Bet Exposure Details</h3>
          <button
...
export default UserBetsExposerDetails;